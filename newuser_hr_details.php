...
<head>
    <meta charset="utf-8">
    <title>New User Form – Details</title>
    ...
    <style>
        ...
        /* Header now supports title row + centered action row */
        .nh-head {
        ...
        /* centered approve/reject under heading */
        .nh-center-actions {
            margin-top: 10px;
            display: flex;
        ...
        <div id="content">
            ...
            <div class="container-fluid p-3">
                <div class="nh-card">
                    ...
                    <div class="nh-head">
                        <div class="nh-top">
                            <h1>New User Form – Details (Form # <?php echo (int)$row['id']; ?>)</h1>

                            <div class="nh-actions">
                                <a href="new_user_home.php"><i class="fa-solid fa-house"></i> Home</a>
                                <a href="newuserhr.php"><i class="fa-solid fa-arrow-left"></i> Back</a>
                            </div>
                        </div>
                    ...
                    <!-- ✅ CENTER approve/reject below heading -->
                    <div class="text-center mb-3">
                        <a class="btn btn-success btn-sm" href="newuser_hr_approve.php?id=<?php echo (int)$row['id']; ?>">
                            <i class="fa-solid fa-check"></i> Approve
                        </a>
                        <a class="btn btn-danger btn-sm" href="newuser_hr_reject.php?id=<?php echo (int)$row['id']; ?>">
