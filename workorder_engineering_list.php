...
$whereParts = [];
$whereParts[] = "(
  (head_status = 'Approved' OR be_role = 'approver' OR ceo_msg != '') AND
  engineering_status = 'Pending' AND
  amount <= 10000 AND amount != 'TBD' AND
  depart_type = 'Engineering'
)";
...
<head>
  ...
  <title>Work Order - Engineering Approval</title>
  ...
  <style>
    ...
    /* ✅ Action buttons (same compact vibe) */
    .btn-details {
      font-size: 11px;
    ...
    /* =========================================================
       ✅ SAME TABLE FIXES (like estimatecost):
       - table area height: 90vh
       - horizontal scrollbar for wide columns
       - sticky header
       - prevent ugly wrapping (Urgent etc)
       - wrap ONLY long text columns (td-wrap)
    ========================================================= */
    ...
    /* default: keep one-line in cells */
    .table-responsive.dt-wrap td {
      white-space: nowrap;
      background: #fff;
    }

    /* wrap only where you already used td-wrap */
...
<body>
  <div class="wrapper">
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0 box1-heading">Engineering Dept. Approval</h5>
              </div>
          ...
          <?php if ($flash): ?>
            <div class="alert alert-<?php echo workorder_h($flash['type'] === 'danger' ? 'danger' : ($flash['type'] === 'warning' ? 'warning' : 'success')); ?> shadow-sm border-0 mb-3">
              <?php echo workorder_h($flash['message'] ?? ''); ?>
            </div>
          <?php endif; ?>
                    ...
                    ?>
                        <tr id="row_<?php echo $rid; ?>">
                          ...
                          <td style="white-space:nowrap;">
                            <a href="workorder_engineeringlist_details.php?id=<?php echo $rid; ?>" class="btn-details">
                              <i class="fa-solid fa-arrow-up me-1"></i> Details
                            </a>
                          </td>

                          <td style="white-space:nowrap;">
                            <form method="POST" action="workorder_engineering_approve.php" class="m-0">
                          ...
                          <td style="white-space:nowrap;">
                            <form method="POST" action="workorder_engineering_reject.php" class="m-0" id="engineeringRejectForm<?php echo $rid; ?>">
                              <?php echo workorder_csrf_input(); ?>
                              <input type="hidden" name="request_id" value="<?php echo $rid; ?>">
                              <input type="hidden" name="reason" value="">
                              <button type="button" class="btn-reject border-0" onclick="workorderSubmitReason('engineeringRejectForm<?php echo $rid; ?>', 'Enter reason for rejection:')">
    ...
    <script>
      ...
      // ✅ keep your same reject flow (prompt -> redirect)
    </script>
