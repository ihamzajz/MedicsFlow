...
<head>
    <meta charset="utf-8">
    <title>ERP – Department Head Details</title>
                    ...
                    <div class="p-3">
                        ...
                        <div class="text-center mt-3">
                            <a
                                ...
                                href="erp_departmenthead_approve.php?id=<?php echo (int)$row['id']; ?>&email=<?php echo urlencode((string)($row['email'] ?? '')); ?>&name=<?php echo urlencode((string)($row['name'] ?? '')); ?>">
                                <i class="fa-solid fa-circle-check"></i> Approve
                            </a>

                            <a
                                class="btn btn-danger btn-sm"
                                href="erp_departmenthead_reject.php?id=<?php echo (int)$row['id']; ?>&email=<?php echo urlencode((string)($row['email'] ?? '')); ?>&name=<?php echo urlencode((string)($row['name'] ?? '')); ?>">
