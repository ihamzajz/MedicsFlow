...
/* Month+Year + (both dates) => dates must be within that month */
...
$reportTitle = "Water Tanker Records" . ($parts ? " (" . implode(", ", $parts) . ")" : "");
...
if (!$errors && $export === 'excel') {
    ...
    $filename = "water_tanker_records_" . date("Y-m-d_H-i") . ".csv";
...
<head>
    ...
    <title>Water Tanker Record List</title>
                ...
                <div class="col-12 col-xl-11">
                    ...
                    <div class="dash-card">
                        <div class="dash-header">
                            <h6>Water Tanker Record List</h6>
                            ...
                            <div class="panel panel-pad">
                                ...
                                <form method="GET">
                                    ...
                                    <div class="filter-actions">
                                        ...
                                        <div class="right">
                                            <?php if ($hasFilter): ?>
                                                <a class="btn btn-sm btn-sq btn-clear" href="water_tanker_record_list.php">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a class="btn btn-sm btn-sq btn-edit"
                                                               href="water_tanker_record_edit.php?id=<?php echo (int)$r['id']; ?>">
...
function downloadPDF() {
    ...
    doc.save("water_tanker_records.pdf");
}
</script>
