...
/* ✅ Keep your same CEO logic exactly (base scope) */
if ($be_role2 != 'hod') {
  $baseWhere = "
    ceo_status = 'Pending' AND
    hr_status  = 'Pending' AND
    reason_of_request = 'New Position'
  ";
} else {
  $baseWhere = "
    hod_status = 'Approved' AND
    ceo_status = 'Pending' AND
    hr_status  = 'Pending' AND
    reason_of_request = 'New Position'
  ";
...
<head>
  ...
  <title>New Hiring - CEO Approval</title>
  ...
  <style>
    ...
    /* ✅ 90vh scroll wrapper like eng_workorder_rp */
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0" style="font-weight:700;">New Hiring - CEO Approval</h5>
              </div>
                    ...
                    ?>
                        <tr id="row_<?php echo $rid; ?>">
                          <td style="white-space:nowrap;">
                            <a href="new_hiring_form_ceo_details.php?id=<?php echo $rid; ?>" class="btn-details">
