...
$reportTitle = "Gatepass Record List" . ($parts ? " (" . implode(", ", $parts) . ")" : "");
...
if (!$errors && $export === 'excel') {
    ...
    $filename = "gatepass_record_list_" . date("Y-m-d_H-i") . ".csv";
    ...
    fputcsv($out, [
        ...
        "Move From", "Move To", "Prepare By", "Status", "Date of Close", "C/O", "Action"
    ]);
...
<head>
    ...
    <title>Gatepass Record List</title>
                            ...
                            <div class="panel panel-pad">
                                ...
                                <form method="GET">
                                    ...
                                    <div class="filter-actions">
                                        ...
                                        <div class="right">
                                            <?php if ($hasFilter): ?>
                                                <a class="btn btn-sm btn-sq btn-clear" href="gatepass_record_list.php">
                                ...
                                <div class="table-wrap">
                                    <div class="table-responsive">
                                        <table class="table table-hover align-middle">
                                            ...
                                            <tbody>
                                            <?php if ($errors): ?>
                                                <tr><td colspan="14" class="text-center text-muted py-4">Fix filter errors and click Apply.</td></tr>
                                            <?php elseif (!$rows): ?>
                                                <tr><td colspan="14" class="text-center text-muted py-4">No records found</td></tr>
                                            <?php else: ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a class="btn btn-sm btn-sq btn-edit"
                                                               href="gatepass_record_edit.php?id=<?php echo (int)$r['id']; ?>">
...
function downloadPDF() {
    ...
    doc.save("gatepass_record_list.pdf");
}
</script>
