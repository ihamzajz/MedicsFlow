...
if ($be_depart === 'super') {
  ...
  $head_depart_safe = mysqli_real_escape_string($conn, $head_depart);

  $whereParts[] = "be_depart = '{$head_depart_safe}'";
  $whereParts[] = "be_role = 'user'";
  $whereParts[] = "department_head_status = 'Pending'";
  $whereParts[] = "fc_status = 'Pending'";
}
...
<head>
  ...
  <title>ERP Access - Head Approval</title>
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0 box1-heading">ERP Access - Head Approval</h5>
              </div>
                    ...
                    ?>
                        <tr id="row_<?php echo $rid; ?>">
                          <td style="white-space:nowrap;">
                            <a href="erp_dheadlist_details.php?id=<?php echo $rid; ?>" class="btn-details">
