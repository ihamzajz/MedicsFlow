...
<div class="d-flex align-items-center justify-content-between">
    ...
    <h5 class="m-0 text-center" style="flex:1;font-weight:600">Finance Approval</h5>
        ...
        if ($data) {
            while ($row = mysqli_fetch_array($select_q)) {
                ...
                <tbody class="searchable">
                    <tr id="row_<?php echo $row['id']; ?>">
                    <td>
                            <a href="trf_finance_details.php?id=<?php echo $row['id']; ?>"><button class="btn-fixed-text">
                                    View Details
                                </button></a>
                        </td>
