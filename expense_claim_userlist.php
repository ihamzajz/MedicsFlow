...
/* =========================
   Session (same style as cash_purchase_userlist)
========================= */
$id         = $_SESSION['id'] ?? '';
...
/* =========================================================
   ✅ Server-side: Filters + Pagination (same UI as cash_purchase_userlist)
   ✅ Filters in GET so it works across pages
   ✅ SAME user restriction as before:
      - if be_depart != super => show only logged-in user's requests (user_name = fullname)
========================================================= */
$perPage = 50;
...
/* ✅ NEW filters (same like cash_purchase_userlist) */
...
if ($be_depart === 'super') {
  ...
  $fullname_safe = mysqli_real_escape_string($conn, (string)$fullname);
  $whereParts[] = "user_name = '{$fullname_safe}'";
}
...
<head>
  ...
  <title>Expense Claim - Request History</title>
  ...
  <style>
    ...
    /* ✅ table 90vh + scrollbars + sticky header (same as cash_purchase_userlist) */
...
<body>
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0" style="font-weight:700;">Expense Claim - Request History</h5>
              </div>

              <a href="expense_claim_home.php" class="btn btn-dark btn-sm">
                    ...
                    ?>
                        <tr id="row_<?php echo $rid; ?>">
                          <td style="white-space:nowrap;">
                            <!-- keeping your same navigation target -->
                            <a href="expense_claim_form_evidence_upload.php?id=<?php echo $rid; ?>" class="btn-details">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      // ✅ preventDefault approach (same as cash_purchase_userlist)
