...
<head>
  ...
  <title>Work Order - Request History</title>
  ...
  <style>
    ...
    /* ✅ Same mint Total badge as estimatecost */
    .mint-badge {
      display: inline-flex;
      align-items: center;
      gap: 8px;
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0 box1-heading">Work Order - Request History</h5>
                    ...
                    ?>
                        <tr id="row_<?php echo $rid; ?>">
                          <td style="white-space:nowrap;">
                            <a href="workorder_userlist_details.php?id=<?php echo $rid; ?>" class="btn-details">
