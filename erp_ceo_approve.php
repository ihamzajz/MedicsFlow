...
// echo "$email";
$update="UPDATE erpaccess_form SET ceo_status = 'Approved', task_status='Work in progress' WHERE id = $id";
...
try {
    ...
    $mail->Password   = 'ftqzihnmefstibag';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('hamza.mediclabs@gmail.com', 'Medics');
