...
/* =========================================================
   ...
   ✅ SAME user restriction as before:
      - if be_depart != super => show only logged-in user's requests (name = fullname)
========================================================= */
$perPage = 50;
...
/* ✅ NEW filters (same like admin list) */
...
if ($be_depart === 'super') {
  ...
  // ✅ keep same behavior as your old cash_purchase_userlist: filter by name = fullname
  $fullname_safe = mysqli_real_escape_string($conn, (string)$fullname);
  $whereParts[] = "name = '{$fullname_safe}'";
}
...
<head>
  ...
  <title>Cash Purchase - Request History</title>
  ...
  <style>
    ...
    /* ✅ table 90vh + scrollbars + sticky header (same as admin list) */
...
<body>
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0" style="font-weight:700;">Cash Purchase - Request History</h5>
              </div>
                  ...
                  <tbody>
                    ...
                    if ($data) {
                      while ($row = mysqli_fetch_assoc($select_q)) {
                        ...
                        // Evidence sum (JSON array in evidence_numbers)
                    ...
                    ?>
                        <tr id="row_<?php echo $rid; ?>">
                          <td style="white-space:nowrap;">
                            <a href="cash_purchase_user_details.php?id=<?php echo $rid; ?>" class="btn-details">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      // ✅ preventDefault approach (same as admin list)
