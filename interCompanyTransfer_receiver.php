               ...
               <div id="dataTableCont">
                  ...
                  <thead style="background-color:#0D9276;color:white">
                    <tr id="row_<?php echo $row['id']; ?>">
                        <th colspan="2">Receiver&nbsp;Action</th>
                  ...
                  if($data){
                    while ($row=mysqli_fetch_array($select_q)) {
                      ...
                      <tbody class="searchable">
                        <tr id="row_<?php echo $row['id']; ?>">
                        <td>
                          <a href="interCompanyTransfer_receiver_approve.php?id=<?php echo $row['id']; ?>" style="text-decoration: none;"><button class="btn btn-success btn-sm">Approve</button></a>
                          </td>
...
<script>
            function promptReason(itemId) {
                ...
                if (reason != null && reason.trim() !== "") {
                    window.location.href = "interCompanyTransfer_receiver_reject.php?id=" + itemId + "&reason=" + encodeURIComponent(reason);
                }
            }
        </script>
        <script>
