...
/* =========================================================
   ✅ SAME UI + LOGIC as Engineering List (Admin version)
========================================================= */
$perPage = 50;
...
<head>
  ...
  <title>Work Order - Admin Approval</title>
  ...
  <style>
    ...
    /* =========================================================
       ✅ SAME TABLE FIXES (like Engineering list):
...
<body>
  <div class="wrapper">
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0 box1-heading">Admin Dept. Approval</h5>
              </div>
                    ...
                    ?>
                        <tr id="row_<?php echo $rid; ?>">
                          ...
                          <td style="white-space:nowrap;">
                            <a href="workorder_adminlist_details.php?id=<?php echo $rid; ?>" class="btn-details">
                              <i class="fa-solid fa-arrow-up me-1"></i> Details
                            </a>
                          </td>

                          <td style="white-space:nowrap;">
                            <form method="POST" action="workorder_admin_approve.php" class="m-0">
                          ...
                          <td style="white-space:nowrap;">
                            <form method="POST" action="workorder_admin_reject.php" class="m-0" id="adminRejectForm<?php echo $rid; ?>">
                              <?php echo workorder_csrf_input(); ?>
                              <input type="hidden" name="request_id" value="<?php echo $rid; ?>">
                              <input type="hidden" name="reason" value="">
                              <button type="button" class="btn-reject border-0" onclick="workorderSubmitReason('adminRejectForm<?php echo $rid; ?>', 'Enter reason for rejection:')">
    ...
    <script>
      ...
      // ✅ same reject flow (prompt -> redirect)
    </script>
