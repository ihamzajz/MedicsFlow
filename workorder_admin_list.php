                  ...
                  <tbody>
                    ...
                    ?>
                        <tr id="row_<?php echo $rid; ?>">
                          ...
                          <td style="white-space:nowrap;">
                            <a
                              href="workorder_admin_approve.php?id=<?php echo $rid; ?>&email=<?php echo urlencode($rowEmail); ?>&name=<?php echo urlencode($rowName); ?>"
                              class="btn-approve">
    ...
    <script>
      ...
      function promptReason(itemId) {
        ...
        if (reason != null && reason.trim() !== "") {
          window.location.href = "workorder_admin_reject.php?id=" + itemId + "&reason=" + encodeURIComponent(reason);
        }
      }
    </script>
