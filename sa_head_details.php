...
// Determine visible rows: 5,10,15... based on filled rows (same logic as sa_dataentry)
$filled = 0;
for ($i = 1; $i <= 40; $i++) {
...
<head>
    ...
    <title>Staff Allocation - Head Approval</title>
    ...
    <style>
        ...
        /* =========================================================
           TABLE STYLING (same as sa_dataentry)
        ========================================================= */
...
<body>
                ...
                <div class="container-xxl">
                    ...
                    <div class="card shadow-sm border-0 mb-3 topbar-card">
                        <div class="card-body">
                            ...
                            <h5 class="title-center">Staff Allocation - Head Approval</h5>
                                ...
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        <?php for ($i = 1; $i <= 40; $i++): ?>
                                            ...
                                            // Hide rows that are beyond calculated visible rows OR empty name
                                            ...
                                            <tr class="<?= $hiddenClass ?>">
                                                ...
                                                <td class="col-t">
                                                    <input type="text" class="form-control form-control-sm" value="<?= htmlspecialchars($checkin2Val) ?>" readonly>
                                                </td>
                                                <td class="col-t">
                                                    <input type="text" class="form-control form-control-sm" value="<?= htmlspecialchars($checkout2Val) ?>" readonly>
                                                </td>
                                                <td class="col-rem">
                    ...
                    <div class="card shadow-sm border-0 mb-3">
                        <div class="card-body d-flex justify-content-center gap-2 flex-wrap">
                            <a href="sa_head_approve.php?id=<?= (int)$row['id'] ?>" class="btn btn-success btn-sm">
                            ...
                            <a href="sa_head_send.php?id=<?= (int)$row['id'] ?>" class="btn btn-secondary btn-sm">
    ...
    <script>
        // Sidebar (same behavior as sa_dataentry)
        ...
        function promptReason(itemId) {
            ...
            if (reason != null && reason.trim() !== "") {
                window.location.href = "sa_head_reject.php?id=" + itemId + "&reason=" + encodeURIComponent(reason);
            }
        }
    </script>
