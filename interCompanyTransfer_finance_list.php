...
<head>
    ...
    <title>Asset Transfer - Finance List</title>
    <link rel="shortcut icon" type="image/jpg" href="assets/images/fevicon.png"/>


    <!-- Bootstrap CSS CDN -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous"><!-- Poppins Font -->
        ...
        <div id="content">
            ...
            <a class="btn btn-dark btn-sm" href="assets_management_home.php" style="font-size:11px!important"><i class="fa-solid fa-arrow-left"></i> Home</a>
             ...
             <?php
                ...
                $select = "SELECT * FROM interCompanyTransfer_form WHERE finance_status = 'Pending' && receiver_status = 'Pending' ORDER BY user_date DESC";
                ...
                <div class="table-container1">
                  ...
                  <thead >
                    <tr id="row_<?php echo $row['id']; ?>">
                        <th colspan="2">Finance&nbsp;Approval</th>
                  ...
                  if($data){
                    while ($row=mysqli_fetch_array($select_q)) {
                      ...
                      <tbody class="searchable">
                        <tr id="row_<?php echo $row['id']; ?>">
                        <td>
                          <a href="interCompanyTransfer_finance_approve.php?id=<?php echo $row['id']; ?>" style="text-decoration: none;"><button class="btn btn-success btn-sm">Approve</button></a>
                          </td>
                          <td>
...
<script>
            function promptReason(itemId) {
                ...
                if (reason != null && reason.trim() !== "") {
                    window.location.href = "interCompanyTransfer_finance_reject.php?id=" + itemId + "&reason=" + encodeURIComponent(reason);
                }
            }
        </script>
        <script>
