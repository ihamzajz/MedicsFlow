...
/* =========================================================
   ✅ sa_head_list (SAME UI as eng_workorder_rp)
   ✅ Server-side Pagination + Search + Product + Date Range
   ✅ Base: head_status = pending AND complete_status = completed
...
$whereParts = [];
$whereParts[] = "TRIM(LOWER(head_status)) = 'pending'";
$whereParts[] = "TRIM(LOWER(complete_status)) = 'completed'";
...
<head>
  ...
  <title>Staff Allocation - Head List</title>
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0 box1-heading">Staff Allocation - Head List</h5>
              </div>
                ...
                <table class="table table-hover align-middle mb-0" id="myTable">
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                          <td>
                            <a href="sa_head_details.php?id=<?php echo (int)$row['id']; ?>" class="btn-details">
