...
/* =========================================================
   ✅ new_hiring_form_request_history
   ✅ Server-side Pagination + Search + Date Range
   ✅ Request history for logged-in user (user_name = fullname)
   ✅ EXACT UI copied from workorder_userlist (badge + filters + pagination)
...
<head>
  ...
  <title>New Hiring - Request History</title>
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0" style="font-weight:700;">New Hiring - Request History</h5>
              </div>
                    ...
                    ?>
                        <tr id="row_<?php echo $rid; ?>">
                          <td style="white-space:nowrap;">
                            <a href="new_hiring_form_request_history_details.php?id=<?php echo $rid; ?>" class="btn-details">
