...
/* =========================================================
   ✅ Server-side: Filters + Pagination (100/page)
...
$whereParts = [];
$whereParts[] = "depart_type = 'Engineering'";
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0 box1-heading">Engineering Workorder Dashboard</h5>
              </div>
          ...
          <!-- Filters (Engineering List style, but dashboard filters) -->
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body">
          ...
          <div class="card shadow-sm border-0">
            <div class="card-body">
                    ...
                    ?>
                        <tr>
                          ...
                          <td class="td-wrap">
                            ...
                            <?php if ($headDateOnly !== '') { echo "<br>" . htmlspecialchars($headDateOnly); } ?>
                          </td>
                          ...
                          <td class="td-wrap">
                            ...
                            <?php if ($closeoutDateOnly !== '') { echo "<br>" . htmlspecialchars($closeoutDateOnly); } ?>
                          </td>
              ...
              <!-- Pagination (Engineering list style) -->
