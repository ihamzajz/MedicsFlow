<?php 
    ...
    $all_count_query = "SELECT COUNT(*) AS all_count FROM raheel1 WHERE product_name = 'RUMOL CREAM 25GMS'";
    ...
    display: inline-block; /* Ensure the pagination controls are displayed inline to enable scrolling */
     ...
     <div class="row justify-content-center">
            ...
            <nav>
                ...
                <button class="nav-link" id="nav-disabled-tab" data-bs-toggle="tab" data-bs-target="#nav-disabled" type="button" role="tab" aria-controls="nav-disabled" aria-selected="false" disabled>Rumol 25</button>
...
<script>
    ...
    function calculateFreeProducts(quantity) {
                            ...
                            // New slab: 1 free product for every 6 purchased
                            while (quantity >= 6) {
                                freeProducts += Math.floor(quantity / 6);  // Calculate how many free products
                                quantity %= 6;  // Remaining quantity after applying the free products
                            }
    ...
    renderTable(currentPage);
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab" tabindex="0">
                    ...
                    <?php
                        ...
                        $select = "SELECT * FROM raheel1 WHERE product_name = 'RUMOL CREAM 25GMS'";
                ...
                <div class="tab-pane fade" id="nav-group" role="tabpanel" aria-labelledby="nav-group-tab" tabindex="0">
                    ...
                    <?php
                        ...
                        $select = "
                            ...
                            FROM raheel1 
                             WHERE product_name = 'RUMOL CREAM 25GMS'
                ...
                <?php
                   ...
                   // Function to calculate the free products (PHP version of your JavaScript function)
                    ...
                    function calculateFreeProducts($quantity) {
                        ...
                        // New slab: 1 free product for every 6 purchased
                        if ($quantity >= 6) {
                            $freeProducts = floor($quantity / 6);  // Calculate how many free products
                        }
...
<script>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadData() {
                $.ajax({
                    url: 'fetchData_rumol25.php', // Adjust this URL to your backend script
                    type: 'GET',
                    data: {
                        limit: limit,
                        offset: offset,
