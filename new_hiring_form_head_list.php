...
/* =========================================================
   ✅ new_hiring_form_head_list
   ✅ SAME UI as workorder_userlist (cards + filters row + total badge + pagination)
   ✅ Server-side Pagination + Search + Date Range
   ✅ Date column name: date_of_request
   ✅ HOD scope (same as your old logic)
========================================================= */
$perPage = 50;
...
$be_depart_nh_safe = mysqli_real_escape_string($conn, (string)$be_depart_nh);

$whereParts = [];
$whereParts[] = "hod_status = 'Pending'";
$whereParts[] = "ceo_status = 'Pending'";
$whereParts[] = "hr_status  = 'Pending'";
$whereParts[] = "user_be_role2 != 'hod'";
$whereParts[] = "user_be_department = '{$be_depart_nh_safe}'";
...
if ($qRaw !== '') {
  ...
  $whereParts[] = "(
      ...
      OR user_be_department LIKE '{$like}'
...
<head>
  ...
  <title>New Hiring - HOD Approval</title>
  ...
  <div class="wrapper">
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0" style="font-weight:700;">New Hiring - HOD Approval</h5>
              </div>
                    ...
                    ?>
                        <tr id="row_<?php echo $rid; ?>">
                          <td style="white-space:nowrap;">
                            <a href="new_hiring_form_head_details.php?id=<?php echo $rid; ?>" class="btn-details">
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function() {
        ...
        // sidebar toggle (same pattern you use elsewhere)
