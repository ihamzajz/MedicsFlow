<?php 
    ...
    $all_count_query = "SELECT COUNT(*) AS all_count FROM raheel1 WHERE product_name = 'FC FORTE SYRUP 120ML'";
...
<html lang="en">
    <head>
        ...
        <title>FC FORTE SYRUP 120ML</title>
    ...
    display: inline-block; /* Ensure the pagination controls are displayed inline to enable scrolling */
     ...
     <div class="row justify-content-center">
            ...
            <nav>
                ...
                <button class="nav-link" id="nav-disabled-tab" data-bs-toggle="tab" data-bs-target="#nav-disabled" type="button" role="tab" aria-controls="nav-disabled" aria-selected="false" disabled>FC Forte Syrup 120ML</button>
    ...
    renderTable(currentPage);
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab" tabindex="0">
                    ...
                    <?php
                        ...
                        $select = "SELECT * FROM raheel1 WHERE product_name = 'FC FORTE SYRUP 120ML'";
                ...
                <div class="tab-pane fade" id="nav-group" role="tabpanel" aria-labelledby="nav-group-tab" tabindex="0">
                    ...
                    <?php
                        ...
                        $select = "
                            ...
                            FROM raheel1 
                             WHERE product_name = 'FC FORTE SYRUP 120ML'
...
<script>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadData() {
                $.ajax({
                    url: 'fetchData_fcfs.php', // Adjust this URL to your backend script
                    type: 'GET',
                    data: {
                        limit: limit,
                        offset: offset,
