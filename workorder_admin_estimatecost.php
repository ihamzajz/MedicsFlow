    ...
    if ($update_q) {
      ...
      if ((float)$budget <= 10000) {
        try {
          ...
          $mail->addAddress('jawwad.ali@medicslab.com', 'Admin Head');
          // $mail->addAddress('muhammad.hamza@medicslab.com', 'Admin Head');
          ...
          error_log("PHPMailer Admin (<=10000) error: " . $mail->ErrorInfo);
        ...
        try {
          ...
          // $mail->addAddress('muhammad.hamza@medicslab.com', 'Danish Tanveer');
      ...
      echo '<script>alert("failed!"); window.location.href="workorder_admin_estimatecost.php";</script>';
      exit;
    }
  }
}
