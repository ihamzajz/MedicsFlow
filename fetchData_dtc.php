...
$query = "SELECT * FROM raheel1 WHERE product_name = 'DIGAS TABLET CLASSIC 120S'";
...
$total_query = "SELECT COUNT(*) as total FROM raheel1 WHERE product_name = 'DIGAS TABLET CLASSIC 120S'";
