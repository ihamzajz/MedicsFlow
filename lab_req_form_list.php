    ...
    <body>
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div id="content">
                ...
                $select = "SELECT * FROM lab_req";

                $select_q = mysqli_query($conn,$select);
                $data = mysqli_num_rows($select_q);
                   ?>
                
                <h6 class="text-center" style="font-size:22px;font-weight:600">Product List</h6>
                    ...
                    while ($row=mysqli_fetch_array($select_q)) {
                      ...
                      <tbody class="searchable">
                        <tr id="row_<?php echo $row['id']; ?>">
                          ...
                          <td>
                                    <a href="lab_req_chest_rub_edit.php?id=<?php echo $row['id']; ?>"><button class="btn btn-sm btn-success" style="font-size:13px!important">
                                    Edit
                                    </button></a>
                                </td>       
                                
                                <td>
                                    <a href="lab_req_chest_rub_history.php?id=<?php echo $row['id']; ?>"><button class="btn btn-sm btn-danger" style="font-size:13px!important">
                                    History
                                    </button></a>
                                </td> 
                      </tr>
