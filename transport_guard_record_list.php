...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax']) && $_POST['ajax'] === '1' && ($_POST['action'] ?? '') === 'delete') {
    ...
    $stmt = $conn->prepare("DELETE FROM transport_guard WHERE id = ?");
...
// Fetch records
$rows = [];
$res = $conn->query("SELECT id, transport_name, status FROM transport_guard ORDER BY id DESC");
if ($res) {
                ...
                <div class="col-md-10 pt-md-2">
                    ...
                    <div class="card shadow">
                        <div class="card-header bg-header text-white d-flex justify-content-between align-items-center">
                            <h6 class="mb-0">Transports</h6>
                            <div class="d-flex gap-2">
                                <a href="transport_guard_form.php" class="btn btn-info btn-sm">
                                ...
                                <div class="d-flex flex-column flex-md-row gap-2 align-items-md-center justify-content-between mb-3">
                                    <div class="d-flex gap-2 flex-wrap">
                                        <div class="searchbox">
                                            ...
                                            <input type="text" id="tableSearch" placeholder="Search transport name...">
                                        </div>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sortable" data-sort="name">
                                                    Transport Name <i class="fa-solid fa-sort"></i>
                                                </th>
                                        ...
                                        <tbody id="tableBody">
                                            <?php foreach ($rows as $r): ?>
                                                <tr id="row_<?php echo (int)$r['id']; ?>"
                                                    ...
                                                    data-name="<?php echo htmlspecialchars(mb_strtolower($r['transport_name'])); ?>"
                                                    ...
                                                    <td class="td-name">
                                                        <?php echo htmlspecialchars($r['transport_name']); ?>
                                                    </td>
                                                    ...
                                                    <td class="td-actions">
                                                        <a class="btn btn-sm btn-primary"
                                                           href="transport_guard_record_edit.php?id=<?php echo (int)$r['id']; ?>">
