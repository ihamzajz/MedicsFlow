...
/* =========================================================
   ...
   ✅ Dashboard: shows ALL (like your old dashboard) — no user restriction
========================================================= */
$perPage = 50;
...
<head>
  ...
  <title>Expense Claim Dashboard</title>
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0" style="font-weight:700;">Expense Claim Dashboard</h5>
              </div>
                    ...
                    ?>
                        <tr id="row_<?php echo $rid; ?>">
                          <td style="white-space:nowrap;">
                            <a href="expense_claim_dashboard_details.php?id=<?php echo $rid; ?>" class="btn-details">
