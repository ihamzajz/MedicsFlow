...
<head>
    ...
    <title>Bonus Approval Delete</title>
                ...
                <tbody class="searchable">
                    <tr>
                        <!-- <td rowspan="<?php echo count($products); ?>">
                            <a href="bonus_userlist_edit.php?id=<?php echo $row['id']; ?>" style="text-decoration: none;"><button class="btn btn-success btn-sm">Edit</button></a>
                        </td> -->
                        <td rowspan="<?php echo count($products); ?>">
                            <a href="bonus_userlist_delete.php?id=<?php echo $row['id']; ?>" style="text-decoration: none;color: red;"><button class="btn btn-danger btn-sm">Delete</button></a>
                        </td>
                        <td rowspan="<?php echo count($products); ?>"><?php echo $row['id']; ?></td>
