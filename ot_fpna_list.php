        ...
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div id="content">
                ...
                <?php
                    ...
                    $select = "SELECT * FROM ot WHERE 
                    hr_submission = 'Approved'
                ...
                <div id="dataTableCont table-responsive">
                    ...
                    <tr>
                        ...
                        <tbody class="searchable">
                            <tr>
                            <td>
                                    <a href="ot_fpna_details.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning" style="font-size:10px!important;font-weight:600!important;letter-spacing:0.5px!important">
                                        View Details
