...
/* =========================
   ✅ Approve/Reject endpoints (dynamic)
...
if ($goesFinance) {
    $approveFile = 'workorder_finance_approve.php';
    $rejectFile  = 'workorder_finance_reject.php';
} else if ($showEngineering) {
    $approveFile = 'workorder_engineering_approve.php';
    $rejectFile  = 'workorder_engineering_reject.php';
} else if ($showAdmin) {
                ...
                <div class="nh-card">
                    ...
                    <div class="nh-head">
                        ...
                        <div class="nh-actions">
                            ...
                            <a href="workorder_engineering_list.php"><i class="fa-solid fa-arrow-left"></i> Back</a>
                        </div>
                    </div>
                    ...
                    <div class="p-3">
                        ...
                        <!-- ✅ Finance / Engineering / Admin blocks -->
                        <?php if ($goesFinance): ?>
