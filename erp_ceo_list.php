...
?>
	...
	<div class="wrapper d-flex align-items-stretch">
      ...
      <div id="content">
            ...
            <h3 class="text-center pb-3" style="font-size: 25px;">Pending (CEO) ERP Access Requests</h3>
             ...
             <?php
				...
				include 'dbconfig.php';
				$select = "SELECT * FROM erpaccess_form WHERE role = 'Head of department' AND
                ceo_status = 'Pending'";
				...
				<div id="dataTableCont">
					...
					<thead class="thead-dark">
                      ...
                      <th scope="col">scm_purchase</th>
                      <th scope="col">scm_inventory</th>
                      <th scope="col">scm_production</th>
                      <th scope="col">scm_sales</th>
                      <th scope="col">scm_misc</th>
                      <th scope="col">scm_admin_Setup</th>
                      <th scope="col">scm_general_ledger</th>
                      <th scope="col">scm_accounts_payable</th>
                      <th scope="col">hcm</th>
						...
						while ($row=mysqli_fetch_array($select_q)) {
							...
							<tbody>
								<tr id="row_<?php echo $row['id']; ?>">
                                    ...
                                    <td><a href="erp_ceo_approve.php?id=<?php echo $row['id']; ?>&email=<?php echo $row['email']; ?>&name=<?php echo $row['name']; ?>" class="text-success" style="text-decoration: none;color: green;">Approve<a/>
                                    </td>
                                    <td ><a href="erp_ceo_reject.php?id=<?php echo $row['id']; ?>&email=<?php echo $row['email']; ?>&name=<?php echo $row['name']; ?>" style="text-decoration: none;color: red;">Reject<a/>
                                    </td>
                                      <td>
