								...
								<div class="d-flex align-items-center justify-content-between mb-3" style="min-height: 40px;">
									...
									<div>
										...
										<a class="btn btn-secondary btn-sm"
											href="cash_purchase_dashboard.php"
											style="font-size:12px!important">
								...
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
											...
											<?php } ?>
											<!-- <tr style="border:0px solid white!important">
												<td colspan="6" style="text-align:right;" class="pt-3">
													<a href="" style="font-size:12.5px!important;color:#1A2A80!important">
														<u><strong><i class="fa-regular fa-envelope"></i> Send Email to Admin
																Department</strong></u>
													</a>
												</td>
											</tr> -->
												...
												<td colspan="6">
													<form method="POST">
														<label for="finance_comments"
															...
															Comments</label>
														<input class="p-2" name="finance_comments" id="admin_comments"
															style="width:100%;background-color:#DBDFEA"
