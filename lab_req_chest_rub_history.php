...
<head>
    ...
    <title>Lab Req - Medics Chest Rub - History</title>
        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
             ...
             <?php
                ...
                $select = "SELECT * FROM lab_req_2 order by date desc";

                $select_q = mysqli_query($conn,$select);
                $data = mysqli_num_rows($select_q);
                   ?>

<h6 class="" style="font-size:22px;font-weight:600">Medics Chest Rub - History <span style="float:right!important"><a href="lab_req_form_list.php" class="btn btn-dark"><i class="fa-solid fa-list-ul"></i> Product List</a></span></h6>
