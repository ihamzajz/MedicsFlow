            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="row pb-1" >
                        ...
                        <div class="col-md-1">
                        <a href="expense_zsm_approve.php?id=<?php echo $row['id']; ?>&email=<?php echo $row['email']; ?>&name=<?php echo $row['name']; ?>" style="text-decoration: none;"><button class="btn btn-success btn-sm">Approve</button></a>
                        </div>

                        <div class="col-md-1">
                        <a href="expense_zsm_reject.php?id=<?php echo $row['id']; ?>&email=<?php echo $row['email'];?>&name=<?php echo $row['name']; ?>" style="text-decoration: none;color: red;"><button class="btn btn-danger btn-sm">Reject</button></a>
                        </div>
                    </div>
