...
/* =========================================================
   ✅ sa_fpna_list (SAME UI as sa_dataentry_list / eng_workorder_rp)
   ✅ Server-side Pagination + Search + Product + Date Range
   ✅ Filters work across ALL pages via GET params
   ✅ Base condition: head_status=Approved AND fpna_status=Pending
========================================================= */
$perPage = 50;
...
// Base filter
$whereParts[] = "head_status = 'Approved'";
$whereParts[] = "fpna_status = 'Pending'";
...
if ($qRaw !== '') {
  ...
  $whereParts[] = "(
      ...
      OR `date` LIKE '{$like}'
      OR day LIKE '{$like}'
      OR head_status LIKE '{$like}'
      OR fpna_status LIKE '{$like}'
  )";
}
...
<head>
  ...
  <title>Staff Allocation - FPNA List</title>
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0 box1-heading">Staff Allocation - FPNA List</h5>
              </div>

              <a href="sa_home.php" class="btn btn-dark btn-sm">
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr id="row_<?php echo (int)$row['id']; ?>">
                          <td>
                            <a href="sa_fpna_details.php?id=<?php echo (int)$row['id']; ?>" class="btn-details">
