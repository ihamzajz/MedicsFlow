...
$query = "SELECT * FROM raheel1 WHERE product_name = 'DIGAS ANTACID SUSPENSION 120ML'";
...
$total_query = "SELECT COUNT(*) as total FROM raheel1 WHERE product_name = 'DIGAS ANTACID SUSPENSION 120ML'";
