...
$update="UPDATE erpaccess_form SET fc_status = 'Approved',fc_msg = 'Approved By $name', task_status='Approved By $name' WHERE id = $id";
...
try {
    ...
    //Recipients
    $mail->setFrom('ihamzajz@gmail.com', 'Medics Digital Form');
