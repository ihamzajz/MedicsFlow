    ...
    <body>
                    ...
                    <form class="form pb-3" method="POST" style="border: 1px solid black; padding: 25px; padding-bottom: 0px; border-radius: 2px;background-color:white!important" >
                        <div class="d-flex align-items-center justify-content-between pb-3" style="position: relative;">
                            <div>
                                ...
                                <a class="btn btn-dark btn-sm" href="newproductidea_userlist.php" style="font-size:11px!important;">
                        ...
                        <!-- <div class="row">
                            <div class="col">
                                <div class="text-center py-3">
                                    ...
                                    <a href="#" class="btn btn-success" onclick="promptReason2(<?php echo $row['id']; ?>)" ><i class="fa-regular fa-circle-check"></i> Approve</a>
                                    <a href="#" class="btn btn-danger" onclick="promptReason(<?php echo $row['id']; ?>)" ><i class="fa-regular fa-circle-xmark"></i> Reject</a>
                                </div>
                            </div>
                        </div> -->
                    </form>
        ...
        <script>
            function promptReason(itemId) {
                ...
                if (reason != null && reason.trim() !== "") {
                    window.location.href = "newproductidea_bd_reject.php?id=" + itemId + "&reason=" + encodeURIComponent(reason);
                }
            }
        </script>
        <script>
        ...
        <script>
            function promptReason2(itemId) {
                ...
                if (reason != null && reason.trim() !== "") {
                    window.location.href = "newproductidea_bd_approve.php?id=" + itemId + "&reason=" + encodeURIComponent(reason);
                }
            }
        </script>
        <script>
