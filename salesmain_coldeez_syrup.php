<?php 
    ...
    $all_count_query = "SELECT COUNT(*) AS all_count FROM raheel1 WHERE product_name = 'COLDEEZ SYRUP'";
    ...
    display: inline-block; /* Ensure the pagination controls are displayed inline to enable scrolling */
     ...
     <div class="row justify-content-center">
            ...
            <nav>
                ...
                <button class="nav-link" id="nav-disabled-tab" data-bs-toggle="tab" data-bs-target="#nav-disabled" type="button" role="tab" aria-controls="nav-disabled" aria-selected="false" disabled>Coldeez Syrup</button>
      ...
      <!-- a end -->
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab" tabindex="0">
                    ...
                    <?php
                        ...
                        $select = "SELECT * FROM raheel1 WHERE product_name = 'COLDEEZ SYRUP'";
                ...
                <div class="tab-pane fade" id="nav-group" role="tabpanel" aria-labelledby="nav-group-tab" tabindex="0">
                    ...
                    <?php
                        ...
                        $select = "
                            ...
                            FROM raheel1 
                             WHERE product_name = 'COLDEEZ SYRUP'
