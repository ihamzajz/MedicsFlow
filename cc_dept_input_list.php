...
$select = "SELECT * FROM qc_ccrf WHERE qchead_status = 'Approved' and status = 'Open' order by code desc";
...
<div class="d-flex align-items-center justify-content-between">
    ...
    <h6 class="m-0 text-center" style="flex:1;font-weight:600">Change Control List - Department Input</h6>
        ...
        if ($data) {
            while ($row = mysqli_fetch_array($select_q)) {
                ...
                <tbody class="searchable">
                    <tr id="row_<?php echo $row['id']; ?>">
                        <td>
                            <a href="cc_dept_input_details.php?id=<?php echo $row['id']; ?>"><button
                                    class="btn-input-text"
                                    >
                                    <i class="fa-solid fa-pen"></i> Input Here
                                </button></a>
                        </td>
