...
<head>
    ...
    <title>Freedom Record List</title>
                            ...
                            <div class="panel panel-pad">
                                ...
                                <form method="GET">
                                    ...
                                    <div class="filter-actions">
                                        <div class="left d-flex gap-2 flex-wrap align-items-center">
                                            <span class="showing-msg"><?php echo $showingHtml; ?></span>
                                        </div>

                                        <div class="right">
                                            <?php if ($hasFilter): ?>
                                                <a class="btn btn-sm btn-sq btn-clear" href="freedom_record_list.php">
                                ...
                                <div class="table-wrap">
                                    <div class="table-responsive">
                                        <table class="table table-hover align-middle">
                                            ...
                                            <tbody>
                                            <?php if ($errors): ?>
                                                <tr><td colspan="10" class="text-center text-muted py-4">Fix filter errors and click Apply.</td></tr>
                                            <?php elseif (!$rows): ?>
                                            ...
                                            <?php else: ?>
                                                <?php foreach ($rows as $r): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-sm btn-edit btn-sq"
                                                               href="freedom_record_edit.php?id=<?php echo (int)$r['id']; ?>">
