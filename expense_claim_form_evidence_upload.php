	...
	<div class="wrapper d-flex align-items-stretch">
					...
					<div class="container-fluid">
						...
						<div class="row justify-content-center">
							<div class="col-12 pt-md-2">
								<form class="form m-5 px-5 py-3" method="POST"
									style="border: 1px solid black; padding: 25px; padding-bottom: 0px; border-radius: 2px;background-color:white!important"
								  ...
								  <div class="d-flex align-items-center justify-content-between mb-3" style="min-height: 40px;">
										...
										<div class="col-md-4">
											<div>
												...
												<input type="text" name="user_name" id="user_name"
													value="<?php echo $row['user_name']; ?>" class="w-100" readonly>
											</div>
										</div>
										<div class="col-md-4">
											<div>
												...
												<input type="text" name="user_department" id="user_department"
													value="<?php echo $row['user_department']; ?>" class="w-100"
													readonly>
											</div>
										</div>
										<div class="col-md-4">
											<div>
												...
												<input type="text" name="user_role" id="user_role"
													value="<?php echo $row['user_role']; ?>" class="w-100" readonly>
											</div>
										</div>
									</div>
									<div class="row mb-md-2">
										<div class="col-md-4">
											<div>
												...
												<input type="number" name="emp_id" id="emp_id"
													value="<?php echo $row['emp_id']; ?>" class="w-100" readonly>
											</div>
										</div>
										<div class="col-md-4">
											<div>
												...
												<input type="text" name="user_date" id="user_date"
													value="<?php echo $row['user_date']; ?>" class="w-100" readonly>
											</div>
										</div>
										<div class="col-md-4">
											<div>
												...
												<input type="number" name="amount" id="amount"
													value="<?php echo $row['amount']; ?>" class="w-100" readonly>
											</div>
										</div>
									</div>
									<div class="row mb-md-2">
										<div class="col-12">
											<div>
												...
												<input type="text" name="reason_for_claim" id="reason_for_claim"
													value="<?php echo $row['reason_for_claim']; ?>" class="w-100"
													readonly>
											</div>
										</div>
									</div>
										...
										<div class="col-12">
											<div>
												...
												<input type="text" name="amount_breakup" id="amount_breakup"
													value="<?php echo $row['amount_breakup']; ?>" class="w-100"
													readonly>
											</div>
										</div>
									</div>
									...
									<form method="POST">
										<!-- Admin Comments -->
										<div class="mb-3 mt-3">
											<label for="admin_comments" style="font-weight:700; display:block; margin-bottom:5px;font-size:13px!important">
												Admin Comments
											</label>
											<input type="text"
												class="p-2"
										...
										<!-- Finance Comments -->
										<div class="mb-3">
											<label for="finance_comments" style="font-weight:700; display:block; margin-bottom:5px;font-size:13px!important">
												Finance Comments
											</label>
											<input type="text"
												class="p-2"
									...
									<div class="bg-white px-5 py-3 mt-3 m-5" style="border:0.5px solid black!important">
        ...
        ">
												...
												<?php if ($row['status'] === 'Open'): ?>
													...
													<div class="col-md-4" style="border-right: 2px solid #000;">
														...
														<button type="submit" name="upload_evidence" class="button-uploadevidenceN">
															<i class="fa-solid fa-upload"></i> Upload Evidence </button>
												...
												<?php if (!empty($row['evidence'])): ?>
													...
													<div class="col-md-4 text-start" style="<?php echo ($row['status'] !== 'Open') ? 'padding-left:7px;margin-left:0px;' : ''; ?>">
										...
										<div class="mb-0 mt-3" style="line-height:1.6;">
                                        ...
                                        <b>Final Status:</b>
                                        <span style="color: <?= ($row['status'] == 'Open') ? 'green' : (($row['status'] == 'Closed') ? 'red' : 'black'); ?>;">
										...
										<?php else: ?>
											<div class="d-flex align-items-center flex-wrap bg-light border rounded px-3 py-2 mb-2"
												style="gap: 20px; border-left:4px solid grey;">
												<p class="mb-0 text-dark" style="font-size:13px;">
													<strong>Final Status:</strong>
													<span style="color:black; font-weight:600;"><?= htmlspecialchars($row['status']); ?></span>
												</p>
											</div>
										<?php endif; ?>
									</div>
