...
<body>
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content">
            ...
            $select = "SELECT * FROM assets ORDER BY id DESC";
                ...
                <div class="table-container1">
                    <!-- <div class="d-flex justify-content-between align-items-center mb-2 flex-wrap">
                            <div>
                                ...
                                <a href="asset_receipt_form" class="btn btn-primary" style="font-size:12px!important;">
                            ...
                            <input type="text" id="filter" class="form-control form-control-sm" placeholder="Search..." style="min-width: 200px;">
                        </div> -->
                    <div class="d-flex align-items-center mb-2 px-3">
                        <!-- Left Buttons -->
                        <div class="d-flex">
                            <a class="btn-home me-2" href="assets_management_home.php"
                        ...
                        <div style="min-width:200px;">
                            <input type="text" id="filter" class="form-control form-control-sm" placeholder="Search..." style="border: .5px solid black !important;">
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            function loadData() {
                $.ajax({
                    url: 'fetchData_asset_management.php',
                    type: 'GET',
                    data: {
                        limit: limit,
                        offset: offset,
