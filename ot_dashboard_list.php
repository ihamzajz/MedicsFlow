...
<html>
    <head>
        ...
        <title>Over Time - Dashboard</title>
        ...
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div id="content">
                ...
                <?php
                    ...
                    $select = "SELECT * FROM ot ORDER BY user_date DESC";
                ...
                <div id="dataTableCont table-responsive">
                    ...
                    <thead style="background-color:#0D9276;color:white">
                        ...
                        <tbody class="searchable">
                            <tr>
                                <td>
                                    <a href="ot_dashboard_details.php?id=<?php echo $row['id']; ?>" class="btn  btn-sm btn-warning" style="font-size:10px!important;font-weight:600!important;letter-spacing:0.5px!important">
                                        View Details
