	...
	<div class="wrapper d-flex align-items-stretch">
      ...
      <div id="content">
            ...
            <a class="btn btn-dark btn-sm" href="workorder_home.php" style="font-size:11px!important"><i class="fa-solid fa-arrow-left"></i> Home</a>
             ...
             <input id="filter" type="text" class="form-control" placeholder="Search here..." style="height: 30px; display:inline;font-size:11px!important">
            </div>
				<?php
							...
							<tbody  class="searchable">
								<tr id="row_<?php echo $row['id']; ?>">
									<td><?php echo $row['id']?>
                                      ...
                                      <td><a href="workorder_engineeringall_details.php?id=<?php echo $row['id']; ?>"><button class="btn btn-sm btn-secondary">
                                    View Details
                                    </button></a>
                                </td>
								</tr>
...
$('[data-bs-toggle="collapse"]').on('click', function () {
    ...
    <script type="text/javascript">
        ...
        $('#excel-general').click(function() {
            $('#myTable-general').tableExport({ type: 'excel',ignoreColumn: [16] });
        });
    });
    </script>
        ...
        $('#excel-mb').click(function() {
            $('#myTable-mb').tableExport({ type: 'excel',ignoreColumn: [16] });
        });
    });
    </script>
