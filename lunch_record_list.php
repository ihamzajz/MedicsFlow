...
if (!$errors && $export === 'excel') {
    ...
    $filename = "lunch_record_list_" . date("Y-m-d_H-i") . ".csv";
...
<head>
    ...
    <style>
        ...
        table{ margin:0; min-width: 1750px; }
        .table thead th{
            position: sticky;
            top: 0;
            z-index: 5;
                            ...
                            <div class="panel panel-pad">
                                ...
                                <form method="GET">
                                    ...
                                    <div class="filter-actions">
                                        ...
                                        <div class="right">
                                            <?php if ($hasFilter): ?>
                                                <a class="btn btn-sm btn-sq btn-clear" href="lunch_record_list.php">
                            ...
                            <div class="panel mt-3">
                                <div class="table-responsive">
                                    <table class="table table-hover align-middle">
                                        ...
                                        <tbody>
                                        <?php if ($errors): ?>
                                            <tr><td colspan="22" class="text-center text-muted py-4">Fix filter errors and click Apply.</td></tr>
                                        <?php elseif (!$rows): ?>
                                            <tr><td colspan="22" class="text-center text-muted py-4">No records found</td></tr>
                                        <?php else: ?>
                                            <?php foreach ($rows as $r): ?>
                                                <tr>
                                                    <td>
                                                        <a class="btn btn-sm btn-sq btn-edit"
                                                           href="lunch_record_edit.php?id=<?php echo (int)$r['id']; ?>">
...
function downloadPDF() {
    ...
    doc.save("lunch_record_list.pdf");
}
</script>
