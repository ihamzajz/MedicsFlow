        ...
        <div id="content">
            ...
            <h6 class="text-center heading-main px-2 py-3">
             ...
             <?php
                ...
                $select = "SELECT * FROM batch WHERE status = 'active'";
                    ...
                    while ($row=mysqli_fetch_array($select_q)) {
                      ...
                      <tbody class="searchable">
                        ...
                        <td><?php echo $row['name']?></td>
                          ...
                          <td><a href="batch_make_inactive.php?id=<?php echo $row['id']; ?>"><button class="btn btn-sm" style=";color:red;font-size:12px">Inactive</button></a></td>
                      </tr>
                      </tbody>
