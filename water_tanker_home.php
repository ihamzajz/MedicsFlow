...
<div class="container py-4">
  ...
  <div class="wt-header">
    <div class="d-flex align-items-center justify-content-between">
      <div>
        <h5 class="fw-bold">Water Tanker</h5>
        <small>Manage tanker records, dashboard and updates</small>
      </div>
  ...
  <div class="row g-3">
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">
      <a href="water_tanker_form.php" class="wt-link">
        <div class="wt-card text-center">
          ...
          <div class="wt-desc">
            Add new water tanker entry with supplier, quantity and date.
          </div>
        </div>
      </a>
    </div>
    ...
    <!-- Dashboard -->
    <div class="col-lg-3 col-md-4 col-sm-6">
      <a href="water_tanker_dashboard.php" class="wt-link">
        <div class="wt-card text-center">
          ...
          <div class="wt-desc">
            View usage summary, monthly totals and tanker statistics.
          </div>
        </div>
      </a>
    </div>
    ...
    <!-- Edit Records -->
    <div class="col-lg-3 col-md-4 col-sm-6">
      <a href="water_tanker_record_list.php" class="wt-link">
        <div class="wt-card text-center">
          ...
          <div class="wt-desc">
            update existing tanker records safely.
          </div>
        </div>
      </a>
    </div>
