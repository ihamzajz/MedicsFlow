...
<head>
    <meta charset="utf-8">
    <title>New User Form – IT Details</title>
        ...
        <div id="content">
            ...
            <div class="container-fluid p-3">
                <div class="nh-card">
                    ...
                    <div class="nh-head">
                        <div class="nh-top">
                            <h1>New User Form – IT Details (Form # <?php echo (int)$row['id']; ?>)</h1>

                            <div class="nh-actions">
                                <a href="new_user_home.php"><i class="fa-solid fa-house"></i> Home</a>
                                <a href="newuserit.php"><i class="fa-solid fa-arrow-left"></i> Back</a>
                            </div>
                        </div>
                    ...
                    <div class="p-3">
                        ...
                        <!-- HR Info (same as your IT page had) -->
                    ...
                    <!-- ✅ Center action like HR page -->
                    <div class="text-center mb-3">
                        <a href="newuser_it_edit.php?id=<?php echo (int)$row['id']; ?>" class="btn btn-success btn-sm">
                            <i class="fa-solid fa-circle-plus"></i> Add Information
                        </a>
                    </div>
                </div><!-- nh-card -->
            </div><!-- container -->
