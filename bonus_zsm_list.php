...
<head>
    ...
    <title>Bonus Approval Zsm List</title>
...
<body>
    ...
    <table class="table table-bordered mt-1" id="myTable">
        ...
        if($data) {
                ...
                <tbody class="searchable">
                    <tr>
                        <td rowspan="<?php echo count($products); ?>">
                            <a href="bonus_zsm_approve.php?id=<?php echo $row['id']; ?>&email=<?php echo $row['email']; ?>&name=<?php echo $row['name']; ?>" style="text-decoration: none;">
            ...
            echo "<tbody><tr><td colspan='17'>No record found!</td></tr></tbody>";
        }
        ?>
    </table>
</div>
    ...
    <script>
            function promptReason(itemId) {
                ...
                if (reason != null && reason.trim() !== "") {
                    window.location.href = "bonus_zsm_reject.php?id=" + itemId + "&reason=" + encodeURIComponent(reason);
                }
            }
        </script>
        <script>
