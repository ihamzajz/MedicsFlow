...
$query = "SELECT * FROM raheel1 WHERE product_name = 'FC FORTE SYRUP 120ML'";
...
$total_query = "SELECT COUNT(*) as total FROM raheel1 WHERE product_name = 'FC FORTE SYRUP 120ML'";
