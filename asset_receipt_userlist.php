            ...
            <div class="container-fluid">
               <div class="row justify-content-center">
                  ...
                  <a class="btn btn-dark btn-sm" href="assets_management_home.php" style="font-size:11px!important"><i class="fa-solid fa-arrow-left"></i> Home</a>
                     ...
                     <input id="filter" type="text" class="form-control" placeholder="Search here..." style="height: 27px; display:inline;width:160px!important;font-size:11px">
                     <?php
                        ...
                        $select = "SELECT * FROM assets WHERE user_name = '$username' ORDER BY user_date DESC";
                           ...
                           <table class="table table-bordered table-hover" id="myTable">
                              <thead>
                                 ...
                                 <th scope="col">View&nbsp;Detail</th>
                                    ...
                                    <th scope="col">Finance Po Approval</th>
                              ...
                              <tbody class="searchable">
                                 <tr id="row_<?php echo $row['id']; ?>">
                                 <td>
                                       <a href="asset_receipt_details.php?id=<?php echo $row['id']; ?>" style="font-size:10px!important;font-weight:600!important;letter-spacing:0.5px!important">
