								...
								<div class="d-flex align-items-center justify-content-between mb-3" style="min-height: 40px;">
									...
									<div>
										...
										<a class="btn btn-secondary btn-sm"
											href="cash_purchase_admin_list.php"
											style="font-size:12px!important">
									...
									<table class="table">
										...
										<tbody>
											...
											if (is_array($evidenceNumbers) && !empty($evidenceNumbers)) {
												...
												// Format without .00 if integer, handle empty/null as 0
												function formatNoTrailingZeros($num)
												{
													$num = floatval($num); // force numeric
												...
												<td colspan="6">
													<form method="POST">
														<label for="admin_comments"
															...
															class="pt-2">Admin Comments</label>
														<input class="p-2" name="admin_comments" id="admin_comments"
															style="width:100%" value="<?php echo $row['admin_comments']; ?>">
        ...
        ">
										...
										<?php if ($row['admin_status'] === 'Pending'): ?>
											<div class="d-flex align-items-center mb-3" style="gap:10px;">
												...
												<a href="cash_purchase_admin_approve.php?id=<?= $row['id']; ?>"
													class="button-approveN d-flex align-items-center">
													<i class="fa-solid fa-check me-1"></i> Approve
												</a>
												<a href="cash_purchase_admin_reject.php?id=<?= $row['id']; ?>"
