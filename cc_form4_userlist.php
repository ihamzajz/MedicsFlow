                  ...
                  if($data){
                    while ($row=mysqli_fetch_array($select_q)) {
                      ...
                      <tbody class="searchable">
                        <tr id="row_<?php echo $row['id']; ?>">
                        <td>
                                <a href="cc_form4.php?id=<?php echo $row['id']; ?>"><button class="btn btn-sm btn-warning" style="font-size:10px!important;font-weight:600!important;letter-spacing:0.5px!important">
                                View Details
