...
========================================================= */
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ec_action'], $_POST['ec_id'])) {
    $ecid = (int)($_POST['ec_id'] ?? 0);
    $act  = (string)($_POST['ec_action'] ?? '');
    ...
    if ($ecid > 0 && ($act === 'approve' || $act === 'reject')) {
        ...
        // admin_status, admin_msg, admin_date
...
<head>
    ...
    <title>Expense Claim - Admin Approval</title>
...
<body>
                                        ...
                                        ?>
                                                <tr id="row_<?php echo $rid; ?>">
                                                    <td style="white-space:nowrap;">
                                                        <a href="expense_claim_admin_details.php?id=<?php echo $rid; ?>" class="btn-details">
                                                    ...
                                                    <?php if (strcasecmp($adminStatusVal, 'Pending') === 0) { ?>
                                                        <td style="white-space:nowrap;">
                                                            <form method="POST" action="" class="m-0">
                                                                <input type="hidden" name="ec_id" value="<?php echo $rid; ?>">
    ...
    <script>
        document.getElementById('exportBtn').addEventListener('click', function() {
            ...
            XLSX.writeFile(wb, 'expense_claim_admin_list.xlsx');
        });
    </script>
