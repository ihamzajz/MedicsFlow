...
$update = "UPDATE workorder_form SET finance_status = 'Rejected',finance_msg='Rejected By $name',fc_date ='$date', task_status='Rejected By $name' 
, final_status = 'Rejected' WHERE id = $id";
...
<strong>Rejected</strong> by the <strong>Finance Department</strong>.
</p>
