...
$update = "UPDATE qc_ccrf SET dept_head_status = 'Rejected', dept_head_date = '$date', reject_reason2 = '$reason' WHERE id = $id";
...
if ($update_q) {
    ...
    try {
        ...
        $mail->addAddress('muhammad.hamza@medicslab.com', 'QC Head');
...
<p>A Change Control Form (ID: <strong>$id</strong>) has been Rejected by the Departmental Head.</p>
