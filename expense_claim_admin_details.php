                            ...
                            <form class="form pb-3" method="POST" enctype="multipart/form-data">
                                <div class="d-flex align-items-center justify-content-between mb-3" style="min-height: 40px;">
                                    ...
                                    <div>
                                        ...
                                        <a class="btn btn-secondary btn-sm"
                                            href="expense_claim_admin_list.php"
                                            style="font-size:12px!important">
                                ...
                                <div>
                                    <form method="POST">
                                        ...
                                        <button type="submit" name="admin_sub" class="button-commentN mt-2">
                                            Add Comments
                                        </button>
                                    </form>
                                </div>
        ...
        ">
                                    ...
                                    <?php if ($row['admin_status'] === 'Pending'): ?>
                                        <div class="d-flex align-items-center mb-3" style="gap:10px;">
                                            ...
                                            <a href="expense_claim_admin_approve.php?id=<?= $row['id']; ?>"
                                                class="btn btn-success btn-sm d-flex align-items-center"
                                                style="font-size:12.5px; padding:4px 10px;">
                                                <i class="fa-solid fa-check me-1"></i> Approve
                                            </a>
                                            <a href="expense_claim_admin_reject.php?id=<?= $row['id']; ?>"
