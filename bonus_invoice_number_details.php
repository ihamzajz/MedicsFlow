...
font-family: 'Poppins', sans-serif;
   ...
   <body>
    ...
    <div class="row pb-2 justify-content-center">
        <div class="col-md-4">
            <p>Remarks1</p>
            <input type="text" name="remarks" class="w-100">
        </div>

        <div class="col-md-4">
            <p>Type</p>
            <input type="text" name="type" class="w-100">
        </div>
        <div class="col-md-4">
            <p>Comments</p>
            <input type="text" name="f_comments" class="w-100">
        </div>
    </div>
    ...
    <div class="row pb-2 justify-content-center">
        <div class="col-md-4">
            <p>Part of machine</p>
            <input type="text" name="part_of_machine" class="w-100">
        </div>
        <div class="col-md-4">
            <p>Old Code</p>
            <input type="text" name="old_code" class="w-100">
        </div>
        <div class="col-md-4">
            <p>New Code</p>
            <input type="text" name="new_code" class="w-100">
        </div>
    </div>
    ...
    <div class="row pb-3">
        <div class="col-md-4">
            <p>Asset Class</p>
            <input type="text" name="asset_class" class="w-100">
        </div>

        <div class="col-md-4">
            <p>Origin</p>
            <input type="text" name="origin" class="w-100">
        </div>

        <div class="col-md-4">
            <p>Status</p>
            <input type="text" name="status" class="w-100">
        </div>
    </div>
    ...
    <div class="row pb-2">
        <div class="col-md-4">
            <p>Remarks2</p>
            <input type="text" name="remarks2" class="w-100">
        </div>
        <div class="col-md-4">
            <p>Part of far</p>
            <input type="text" name="part_of_far" class="w-100">
        </div>
        <div class="col-md-4">
            <p>Department</p>
            <input type="text" name="f_department" class="w-100">
        </div>
    </div>
    ...
    <div class="row pb-2">
        <div class="col-md-8 pb-2">
            <p>Unique Nuim</p>
            <input type="text" name="unique_nuim" class="w-100">
        </div>
        <div class="col-md-4">
            <p>Item Desc</p>
            <input type="text" name="item_desc" class="w-100">
        </div>
        <div class="col-md-4">
            <p>Balance</p>
            <input type="text" name="balances" class="w-100">
        </div>
        <div class="col-md-4">
            <p>Available Amount</p>
            <input type="text" name="available_amount" class="w-100">
        </div>
    </div>
    ...
    <div class="row pb-2">
        <div class="col-md-8 pb-2">
            <p>Department name</p>
            <input type="text" name="department_name" class="w-100">
        </div>
        <div class="col-md-4">
            <p>Category</p>
            <input type="text" name="category" class="w-100">
        </div>
    ...
    <!-- <div class="row pb-2">
        <div class="col-md-8 pb-2">
            <p>Acc Dept. 2023</p>
            <input type="text" name="f_acc_dept2023" class="w-100">
        </div>
    </div> -->
...
if (isset($_POST['submit'])) {
    ...
    $f_remarks1 = $_POST['remarks'];
    $f_type = $_POST['type'];
    $f_comments = $_POST['f_comments'];
    $f_part_of_machine = $_POST['part_of_machine'];
    $f_old_code = $_POST['old_code'];
    $f_new_code = $_POST['new_code'];
    $f_asset_class = $_POST['asset_class'];
    $f_origin= $_POST['origin'];
    $f_status = $_POST['status'];
    $f_remarks2= $_POST['remarks2'];
    $f_part_of_far = $_POST['part_of_far'];
   
    $f_unique_nuim = $_POST['unique_nuim'];
    $f_item_desc = $_POST['item_desc'];
    $f_balances = $_POST['balances'];
    $f_department_name = $_POST['f_department_name'] ?? null;
    $f_category = $_POST['category'] ?? null;
    $f_available_amount = $_POST['available_amount'] ?? null;
    $date =  date('Y-m-d');
