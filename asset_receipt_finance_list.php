        ...
        <div id="content">
            ...
            <div class="container-fluid">
             ...
             <?php
                ...
                grn_status = 'Approved' AND
                po_no_status = 'Approved' AND
                ...
                <div class="table-container1">
                  ...
                  <thead style="background-color:#0D9276;color:white">
                    <tr id="row_<?php echo $row['id']; ?>">
                      <th scope="col" colspan="2">FP&A&nbsp;Approval</th>
                      <th scope="col">id</th> 
                  ...
                  if($data){
                    while ($row=mysqli_fetch_array($select_q)) {
                      ...
                      <tbody class="searchable">
                        <tr id="row_<?php echo $row['id']; ?>"> 
                          <td>
                                <a href="asset_receipt_finance_approve.php?id=<?php echo $row['id']; ?>"><button class="btn btn-success btn-sm">Approve</button></a>
                          </td>
                          <td>
