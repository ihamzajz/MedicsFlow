...
/* ✅ NEW filters (same as admin list) */
...
<head>
    ...
    <title>Cash Purchase - Finance Approval</title>
    ...
    <style>
        ...
        /* ✅ Table panel (90vh + horizontal/vertical scroll + sticky header) */
        ...
        <div id="content">
            ...
            <div class="container-fluid py-3">
                <div class="container-xxl">
                    ...
                    <!-- ✅ Filters row (NEW status dropdowns like admin list) -->
                    <div class="card shadow-sm border-0 mb-3">
                        <div class="card-body">
                                        ...
                                        ?>
                                                <tr id="row_<?php echo $rid; ?>">
                                                    <td style="white-space:nowrap;">
                                                        <a href="cash_purchase_finance_details.php?id=<?php echo $rid; ?>" class="btn-details">
        ...
        document.getElementById('exportBtn').addEventListener('click', function() {
            ...
            $('#myTable tbody tr:visible').each(function() {
                ...
                data.push([
                    ...
                    cols.eq(8).text().trim(),
                    cols.eq(9).text().trim(),
                    cols.eq(10).text().trim(),
                    cols.eq(11).text().trim()
                ]);
            });
            ...
            XLSX.writeFile(wb, 'cash_purchase_finance_list.xlsx');
        });
    </script>
