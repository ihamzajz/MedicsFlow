...
/* =========================================================
   ...
   Base: ALL records (RP Dashboard)
   Date filter: FORM SUBMIT DATE column = `date`
========================================================= */
$perPage = 50;
...
/* Date range validation + filter (on submit date: DATE(`date`)) */
$hasFrom = ($dateFrom !== '');
$hasTo   = ($dateTo !== '');
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0 box1-heading">New User Dashboard</h5>
              </div>
                ...
                <table class="table table-hover align-middle mb-0" id="myTable">
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr id="row_<?php echo $rid; ?>">
                          <td style="white-space:nowrap;">
                            <a href="newuserrp_details.php?id=<?php echo $rid; ?>" class="btn-details">
                    ...
                    <?php
                      ...
                      echo "<tr><td colspan='8' class='text-muted fw-semibold p-3'>No record found!</td></tr>";
                    }
                    ?>
                  </tbody>
                </table>
