...
<head>
    ...
    <title>QC - Change Control Request Forms</title>
...
<body>
    ...
    <?php
        ...
        <div id="content">
            ...
            <h5 class="text-center pb-2" style="font-weight:bold">QC - Change Control Request Forms</h5> 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4"><a href="qc_ccrf_manager_list.php"><p class="div-1">CCRF Manager List</p></a></div>
                    <div class="col-md-4"><a href="interCompanyTransfer_form.php"><p class="div-2">Asset Transfer Request Form</i></p></a></div>
                    <div class="col-md-4"><a href="fixedAssetsDisposal_form.php"><p class="div-3">Assets Disposal Form</p></a></div>
                </div>
