...
$update="UPDATE fixed_assets_disposal_form SET finance_status = 'Rejected' ,finance_msg = 'Rejected By $approver_name',finance_date = '$date', reason = '$reason', status = 'Rejected' WHERE id = $id";
