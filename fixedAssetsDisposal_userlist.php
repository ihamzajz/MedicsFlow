...
<head>
    ...
    <title>Asset Disposal - Userlist</title>
        ...
        <div id="content">
            ...
            <a class="btn btn-dark btn-sm" href="assets_management_home.php" style="font-size:11px!important"><i class="fa-solid fa-arrow-left"></i> Home</a>
             ...
             <?php
                ...
                $select = "SELECT * FROM fixed_assets_disposal_form WHERE applicant = '$name' ORDER BY date_of_application DESC";
                  ...
                  if($data){
                    while ($row=mysqli_fetch_array($select_q)) {
                      ...
                      <tbody class="searchable">
                        <tr id="row_<?php echo $row['id']; ?>">
                        <td>
                                    <a href="fixed_assets_disposal_userlist_details.php?id=<?php echo $row['id']; ?>" style="text-decoration: none;">
                                        <button class="btn btn-sm btn-secondary" style="font-size:10px!important;font-weight:600!important;letter-spacing:0.5px!important">
                                    View Details
                        ...
                        <td><?php echo $row['disposal_department']?></td>  
                          ...
                          <td><?php echo $row['po_approval_status']?></td> 
