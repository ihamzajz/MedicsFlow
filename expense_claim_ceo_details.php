...
<body>
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content">
            ...
            ?>
                    <div class="container-fluid">
                        <div style="background-color:White!important;border:1px solid black" class="px-5 py-3 m-5">
                            <form class="form pb-3" method="POST" enctype="multipart/form-data">
                                <div class="d-flex align-items-center justify-content-between mb-3" style="min-height: 40px;">
                                    ...
                                    <div>
                                        ...
                                        <a class="btn btn-secondary btn-sm"
                                            href="expense_claim_ceo_list.php"
                                            style="font-size:12px!important">
                                ...
                                <div>
                                    <form method="POST">
                                        <label for="finance_comments"
                                            style="font-weight:600;display:block;margin-bottom:5px;font-size:12px!important">Finance
                                            Comments</label>
                                ...
                                <div>
                                    <form method="POST">
                                        ...
                                        <input class="pb-2" name="admin_comments" id="admin_comments" style="width:100%"
                                            value="<?php echo $row['admin_comments']; ?>" readonly>

                                    </form>
                                </div>

                                <div class="bg-white px-3 py-3 mt-3" style="border:1px solid grey!important;">
                                    <!-- Header -->
        ...
        ">
                                    ...
                                    <?php if ($row['ceo_status'] === 'Pending'): ?>
                                        <div class="d-flex align-items-center mb-3" style="gap:10px;">
                                            <p class="mb-0 fw-semibold text-dark" style="font-size:13px;">

                                            </p>
                                            <a href="expense_claim_ceo_approve.php?id=<?= $row['id']; ?>"
                                                class="button-approveN d-flex align-items-center"
                                                style="font-size:12.5px; padding:4px 10px;">
                                                <i class="fa-solid fa-check me-1"></i> Approve
                                            </a>
                                            <a href="expense_claim_ceo_reject.php?id=<?= $row['id']; ?>"
                                                class="button-rejectN btn-sm d-flex align-items-center"
                                                style="font-size:12.5px; padding:4px 10px;">
                                    ...
                                    <!-- 3rd option -->
                                    <div class="mb-0" style="line-height:1.6;">
