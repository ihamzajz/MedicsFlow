        ...
        <div id="content">
            ...
            <a class="btn btn-dark btn-sm ml-3" href="newproductidea_home.php" style="font-size:11px!important"><i class="fa-solid fa-arrow-left"></i> Home</a>
             ...
             <?php
                ...
                $select = "SELECT * FROM new_product_idea WHERE user_name = '$name'";
                    ...
                    while ($row=mysqli_fetch_array($select_q)) {
                      ...
                      <tbody class="searchable">
                        <tr id="row_<?php echo $row['id']; ?>">
                          ...
                          <td>
                                    <a href="newproductidea_userlist_details.php?id=<?php echo $row['id']; ?>"><button class="btn btn-sm btn-secondary" style="font-size:10.5px!important">
                                    View Details
                                    </button></a>
                                </td>           
                      </tr>
