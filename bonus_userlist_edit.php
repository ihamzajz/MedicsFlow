                ...
                <?php 
                    if($data){
                    	while ($row=mysqli_fetch_array($select_q)) {
                    		?>
                <div class="container">
                    <h6 class="text-center pb-md-4">Ref No: <span class="text-primary"><?php echo $row['custom_id']?></span></h6>
                    <div class="row pb-1">
                        <div class="col-md-3">
                            <p>Name:</p>
                    ...
                    <div class="row pb-2">
                        <div class="col-md-3">
                            <p>Product:</p>
                            <textarea placeholder="<?php echo $row['products_1']?>" rows="4" cols="30"></textarea>
                        </div>
                        <div class="col-md-3">
                            <p>Quantity:</p>
                            <textarea placeholder="<?php echo $row['order_qty_1']?>"  rows="1" cols="30"></textarea>
                            <p>Actual Bonus:</p>
                            <textarea placeholder="<?php echo $row['actual_bonus_1']?>"  rows="1" cols="30"></textarea>
                        </div>
                        <div class="col-md-3">
                        <p>Additional Bonus</p>
                            <textarea placeholder="<?php echo $row['additional_bonus_1']?>"  rows="1" cols="30"></textarea>
                            <p>Total Bonus:</p>
                            <textarea placeholder="<?php echo $row['total_bonus_1']?>"  rows="1" cols="30"></textarea>
                        </div>
                        <div class="col-md-3">
                        <p>Gift:</p>
                            <textarea placeholder="<?php echo $row['gift_1']?>"  rows="1" cols="30"></textarea>
                        </div>
                    </div>
                    <hr class="mt-2 mb-2">
                </div><!-- container end-->
