...
// echo "$email";
$date =  date('Y-m-d H:i:s');
$reason = $_GET['fpna_reason'];

$update="UPDATE ot SET fpna_status = 'Rejected', fpna_msg = 'Rejected By $name', fpna_date =  '$date', fpna_reason = '$reason' WHERE id = $id";
...
try {
    ...
    $mail->Subject = "Overtime Request Update";
