...
<body>
    ...
    <?php
        ...
        <div id="content">
            ...
            <h4 class="text-center pb-2" style="font-weight:bold">Submit Assets Forms</h4> 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4"><a href="asset_receipt_form.php"><p class="div-1">Asset Receipt Form</p></a></div>
