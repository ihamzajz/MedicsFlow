    ...
    display: inline-block; /* Ensure the pagination controls are displayed inline to enable scrolling */
     ...
     <div class="row justify-content-center">
            ...
            <nav>
                ...
                <button class="nav-link" id="nav-disabled-tab" data-bs-toggle="tab" data-bs-target="#nav-disabled" type="button" role="tab" aria-controls="nav-disabled" aria-selected="false" disabled>Digas Colic Drop 20ML (01-Jul-24 to 22-Jul-24)</button>
    ...
    <script>
        (function() {
            ...
            function fetchPage(page, query = '') {
                fetch(`invoice_dcd1.php?page=${page}&search=${encodeURIComponent(query)}`)
    ...
    <script>
        (function() {
            ...
            function fetchDiscrepanciesPage(page, query = '') {
                fetch(`disc_dcd1.php?page=${page}&search=${encodeURIComponent(query)}`)
                    .then(response => response.json())
                    .then(data => {
...
<script>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadData() {
                $.ajax({
                    url: 'fetchData_dcd.php', // Adjust this URL to your backend script
                    type: 'GET',
                    data: {
                        limit: limit,
                        offset: offset,
