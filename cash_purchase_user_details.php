                            	...
                            	<div class="d-flex align-items-center justify-content-between mb-3" style="min-height: 40px;">
									...
									<div>
										...
										<a class="btn btn-secondary btn-sm"
											href="cash_purchase_userlist.php"
											style="font-size:12px!important">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php if (!empty($row['description_1'])): ?>
                                                <tr>
                                                    <td><input type="text" name="sr_1" value="<?php echo $row['sr_1']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="description_1"
                                                            value="<?php echo $row['description_1']; ?>" class="w-100" readonly>
                                                    </td>
                                                    <td><input type="text" name="purpose_1" value="<?php echo $row['purpose_1']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="qty_1" value="<?php echo $row['qty_1']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="price_1" value="<?php echo $row['price_1']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="amount_1" value="<?php echo $row['amount_1']; ?>"
                                                            class="w-100" readonly></td>
                                                </tr>
                                            <?php endif; ?>
                                            <?php if (!empty($row['description_2'])): ?>
                                                <tr>
                                                    <td><input type="text" name="sr_2" value="<?php echo $row['sr_2']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="description_2"
                                                            value="<?php echo $row['description_2']; ?>" class="w-100" readonly>
                                                    </td>
                                                    <td><input type="text" name="purpose_2" value="<?php echo $row['purpose_2']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="qty_2" value="<?php echo $row['qty_2']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="price_2" value="<?php echo $row['price_2']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="amount_2" value="<?php echo $row['amount_2']; ?>"
                                                            class="w-100" readonly></td>
                                                </tr>
                                            <?php endif; ?>
                                            <?php if (!empty($row['description_3'])): ?>
                                                <tr>
                                                    <td><input type="text" name="sr_3" value="<?php echo $row['sr_3']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="description_3"
                                                            value="<?php echo $row['description_3']; ?>" class="w-100" readonly>
                                                    </td>
                                                    <td><input type="text" name="purpose_3" value="<?php echo $row['purpose_3']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="qty_3" value="<?php echo $row['qty_3']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="price_3" value="<?php echo $row['price_3']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="amount_3" value="<?php echo $row['amount_3']; ?>"
                                                            class="w-100" readonly></td>
                                                </tr>
                                            <?php endif; ?>
                                            <?php if (!empty($row['description_4'])): ?>
                                                <tr>
                                                    <td><input type="text" name="sr_4" value="<?php echo $row['sr_4']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="description_4"
                                                            value="<?php echo $row['description_4']; ?>" class="w-100" readonly>
                                                    </td>
                                                    <td><input type="text" name="purpose_4" value="<?php echo $row['purpose_4']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="qty_4" value="<?php echo $row['qty_4']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="price_4" value="<?php echo $row['price_4']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="amount_4" value="<?php echo $row['amount_4']; ?>"
                                                            class="w-100" readonly></td>
                                                </tr>
                                            <?php endif; ?>
                                            <?php if (!empty($row['description_5'])): ?>
                                                <tr>
                                                    <td><input type="text" name="sr_5" value="<?php echo $row['sr_5']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="description_5"
                                                            value="<?php echo $row['description_5']; ?>" class="w-100" readonly>
                                                    </td>
                                                    <td><input type="text" name="purpose_5" value="<?php echo $row['purpose_5']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="qty_5" value="<?php echo $row['qty_5']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="price_5" value="<?php echo $row['price_5']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="amount_5" value="<?php echo $row['amount_5']; ?>"
                                                            class="w-100" readonly></td>
                                                </tr>
                                            <?php endif; ?>
                                            <?php if (!empty($row['description_6'])): ?>
                                                <tr>
                                                    <td><input type="text" name="sr_6" value="<?php echo $row['sr_6']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="description_6"
                                                            value="<?php echo $row['description_6']; ?>" class="w-100" readonly>
                                                    </td>
                                                    <td><input type="text" name="purpose_6" value="<?php echo $row['purpose_6']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="qty_6" value="<?php echo $row['qty_6']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="price_6" value="<?php echo $row['price_6']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="amount_6" value="<?php echo $row['amount_6']; ?>"
                                                            class="w-100" readonly></td>
                                                </tr>
                                            <?php endif; ?>
                                            <?php if (!empty($row['description_7'])): ?>
                                                <tr>
                                                    <td><input type="text" name="sr_7" value="<?php echo $row['sr_7']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="description_7"
                                                            value="<?php echo $row['description_7']; ?>" class="w-100" readonly>
                                                    </td>
                                                    <td><input type="text" name="purpose_7" value="<?php echo $row['purpose_7']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="qty_7" value="<?php echo $row['qty_7']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="price_7" value="<?php echo $row['price_7']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="amount_7" value="<?php echo $row['amount_7']; ?>"
                                                            class="w-100" readonly></td>
                                                </tr>
                                            <?php endif; ?>
                                            <?php if (!empty($row['description_8'])): ?>
                                                <tr>
                                                    <td><input type="text" name="sr_8" value="<?php echo $row['sr_8']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="description_8"
                                                            value="<?php echo $row['description_8']; ?>" class="w-100" readonly>
                                                    </td>
                                                    <td><input type="text" name="purpose_8" value="<?php echo $row['purpose_8']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="qty_8" value="<?php echo $row['qty_8']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="price_8" value="<?php echo $row['price_8']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="amount_8" value="<?php echo $row['amount_8']; ?>"
                                                            class="w-100" readonly></td>
                                                </tr>
                                            <?php endif; ?>
                                            <?php if (!empty($row['description_9'])): ?>
                                                <tr>
                                                    <td><input type="text" name="sr_9" value="<?php echo $row['sr_9']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="description_9"
                                                            value="<?php echo $row['description_9']; ?>" class="w-100" readonly>
                                                    </td>
                                                    <td><input type="text" name="purpose_9" value="<?php echo $row['purpose_9']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="qty_9" value="<?php echo $row['qty_9']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="price_9" value="<?php echo $row['price_9']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="amount_9" value="<?php echo $row['amount_9']; ?>"
                                                            class="w-100" readonly></td>
                                                </tr>
                                            <?php endif; ?>
                                            <?php if (!empty($row['description_10'])): ?>
                                                <tr>
                                                    <td><input type="text" name="sr_10" value="<?php echo $row['sr_10']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="description_10"
                                                            value="<?php echo $row['description_10']; ?>" class="w-100" readonly>
                                                    </td>
                                                    <td><input type="text" name="purpose_10"
                                                            value="<?php echo $row['purpose_10']; ?>" class="w-100" readonly></td>
                                                    <td><input type="text" name="qty_10" value="<?php echo $row['qty_10']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="price_10" value="<?php echo $row['price_10']; ?>"
                                                            class="w-100" readonly></td>
                                                    <td><input type="text" name="amount_10" value="<?php echo $row['amount_10']; ?>"
                                                            class="w-100" readonly></td>
                                                </tr>
                                            <?php endif; ?>
                                            <tr>
                                                <td colspan="5" class="px-2"
                                                    style="text-align: right !important;font-weight:600;font-size:15px">Total
                                                    Amount
                                                </td>
                                                <td><input type="text" name="total_amount"
                                                        value="<?php echo $row['total_amount']; ?>" class="w-100" readonly
                                                        style="color:red;font-weight:600;font-size:15px"></td>
                                            </tr>
                                            <!-- breakdown start  -->
                                            <?php
                                            ...
                                            ?>
                                                <tr>
                                                    <td colspan="6" class="px-5 py-2 text-success bg-light"
                                                ...
                                                <tr>
                                                    <td colspan="4"></td>
                                                    <td colspan="2"
                                                        style="text-align:left;font-weight:400;font-size:12.5px;letter-spacing:.2px!important"
                                                        class="lead">
                                                        <?php foreach ($evidenceNumbers as $i => $num): ?>
                                                            <span style="display:block;"><strong>Evidence <?= $i + 1 ?> </strong> =
                                                                <?= formatNoTrailingZeros($num) ?></span>
                                                        <?php endforeach; ?>
                                                        <hr style="margin:4px 0;">
                                                        <strong>Total Evidence Amount:</strong>
                                                        <?= formatNoTrailingZeros($sumEvidence) ?><br>
                                                        <strong>Amount Requested by user:</strong>
                                                        <?= formatNoTrailingZeros($totalAmount) ?><br>
                                                        <strong>Difference:</strong> <?= formatNoTrailingZeros($difference) ?>
                                                        (<?= $statusText ?>)
                                                    </td>
                                                </tr>
                                                <tr style="border:0px solid white!important">
                                                    <td colspan="6" style="text-align:center;font-size:15px!important;">
                                                        <?php if ($row['paid'] === 'yes'): ?>
                                            ...
                                            <a href="cash_purchase_paid.php?id=<?= $row['id']; ?>"
                                            	class="btn btn-primary">Paid</a>
                                            <?php elseif ($statusText === 'Credit'): ?>
                                            <a href="cash_purchase_receive.php?id=<?= $row['id']; ?>"
                            ...
                            <div class="mb-2">
                                <form method="POST">
                                    <label for="admin_comments"
                                        style="font-weight:600;display:block;margin-bottom:5px;font-size:13px">Admin
                                        Comments</label>
                                    <input class="p-2" name="admin_comments" id="admin_comments"
                                        style="width:100%;background-color:#DBDFEA" value="<?php echo $row['admin_comments']; ?>"
                                        readonly>
                                </form>
                            </div>
                            <!-- Finance Comments -->
                            <div>
                                <form method="POST">
                                    <label for="finance_comments"
                                        style="font-weight:600;display:block;margin-bottom:5px;font-size:13px">Finance
                                        Comments</label>
