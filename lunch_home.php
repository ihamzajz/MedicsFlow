...
<div class="container py-4">
  ...
  <div class="wt-header">
    <div class="d-flex align-items-center justify-content-between">
      <div>
        ...
        <small>Manage lunch records, dashboard and updates</small>
      </div>
  ...
  <div class="row g-3">
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">
      <a href="lunch_form.php" class="wt-link">
        <div class="wt-card text-center">
          ...
          <div class="wt-desc">
            Add new lunch entry with menu, quantity and date.
          </div>
        </div>
      </a>
    </div>
    ...
    <!-- Dashboard -->
    <div class="col-lg-3 col-md-4 col-sm-6">
      <a href="lunch_dashboard.php" class="wt-link">
        <div class="wt-card text-center">
          ...
          <div class="wt-desc">
            View lunch summary, daily counts and statistics.
          </div>
        </div>
      </a>
    </div>
    ...
    <!-- Edit Records -->
    <div class="col-lg-3 col-md-4 col-sm-6">
      <a href="lunch_record_list.php" class="wt-link">
        <div class="wt-card text-center">
          ...
          <div class="wt-desc">
            Update existing lunch records safely.
          </div>
        </div>
      </a>
    </div>
