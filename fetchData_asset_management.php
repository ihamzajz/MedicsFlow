...
// Get total count (with filter if any)
...
for ($i = $startPage; $i <= $endPage; $i++) {
    ...
    $pagination .= '<button data-offset="' . $pageOffset . '" class="btn ' . $btnClass . ' mx-1" style="font-size:11px; border-radius: 0px;">' . $i . '</button>';
}
