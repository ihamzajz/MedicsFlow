...
/* =========================================================
   ✅ SAME UI + LOGIC + Date Range (UNCHANGED)
========================================================= */
$perPage = 50;
...
<head>
    ...
    <title>Work Order - Engineering Closeout</title>
    ...
    <style>
        ...
        /* ✅ Closeout input + save button (compact) */
        .closeout-wrap {
            display: flex;
            align-items: center;
            gap: 8px;
        ...
        /* =========================================================
           ✅ TABLE PANEL FIXES (same as your other pages):
           - 90vh scroll panel
           - horizontal scrollbar for wide columns
           - sticky header
           - prevent ugly wrapping
           - wrap ONLY long-text cells with .td-wrap
        ========================================================= */
                ...
                <div class="container-xxl">
                    ...
                    <div class="card shadow-sm border-0 mb-3">
                        <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
                            <div>
                                <h5 class="mb-0 box1-heading">Engineering Dept. Closeout</h5>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr id="row_<?php echo $rid; ?>">
                                                    ...
                                                    <!-- ✅ keep single line for short values -->
                                        ...
                                        <?php
                                            ...
                                            echo "<tr><td colspan='9' class='text-muted fw-semibold p-3'>No record found!</td></tr>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
