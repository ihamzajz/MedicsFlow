        ...
        <div id="content">
            ...
            <div class="container-fluid">
             ...
             <?php
                ...
                $select = "SELECT * FROM assets WHERE finance_status = 'Approved' AND
                update_date = 'Pending'
               ...
               <div id="dataTableCont table-responsive">
                  ...
                  <thead style="background-color:#0D9276;color:white">
                    <tr id="row_<?php echo $row['id']; ?>">
                      ...
                      <th scope="col">Invoice&nbsp;Nunber</th> 
                  ...
                  if($data){
                    while ($row=mysqli_fetch_array($select_q)) {
                      ...
                      <tbody class="searchable">
                        ...
                        <td><a href="asset_receipt_finance_edit_details.php?id=<?php echo $row['id']; ?>"><button class="btn btn-sm btn-danger" >Edit</button></a></td> 
