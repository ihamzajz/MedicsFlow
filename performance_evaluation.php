                                ...
                                <div class="table-responsive">
                                    <table class="table table2-1">
                                        <thead>
                                            <tr>
                                                <td colspan="5">
                                                    <!-- <h5 class="text-center py-3" style="font-weight: 400;">Performance
                                                        Evaluation Form </br>
                                                        <span style="font-weight: 400;font-size:14px">(for Below
                                                            Mid-Level Managers)</span>
                                                    </h5> -->
                                                    <div
                                                        class="d-flex align-items-center justify-content-between bg-white py-3">
                                                        <!-- Left: Home Button -->
                                                        <a class="btn btn-dark btn-sm" href="appraisal_forms.php">
                                                            <i class="fa-solid fa-home"></i> Home
                                                        </a>
                                                        ...
                                                        <div class="flex-grow-1 text-center">
                                                            <h5 class="m-0" style="font-weight: 600;">
                                                                Performance
                                                                Evaluation Form<br>
                                                                <span style="font-weight: 400; font-size: 14px;">(for
                                                                    Below
                                                                    Mid-Level Managers)</span>
                                                            </h5>
                                                        </div>
                                            ...
                                            <tr>
                                                <td colspan="5"
                                                    ...
                                                    Key Performance Indicator (40% weightage).</br>
                                                    <span
                                                        style="font-size:12.7px!important;!important;font-weight:400">The
                                                        Rating should be 1 to 5 where 1 unsatisfactory and 5 is
                                                        exceptional</span>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <table class="table table2-2">
                                        <thead>
                                            <tr>
                                                <td colspan="5"
                                                    style="font-size:13.5px!important;padding:15px 10px!important;font-weight:500">
                                                    Behavioral Commpetencies (30% Weightage)</br>
                                                    <span
                                                        style="font-size:12.7px!important;!important;font-weight:400">The
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><b>Contious Learning:</b></br>Identifying and addressing
                                                    individuals</br> strength and weakness to enchance</br>personal and
                                                    organizational performance</td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><b>Conflict Management:</b></br>Preventing, managing and/or
                                                    resolving</br>conflicts</td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><b>Planning and organizing:</b></br>Defining tasks and milestones to
                                                    achieve</br>objectives, while ensuring the optional use</br>of
                                                    resources</td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><b>Flexibility:</b></br>Ability to adapt to and work with a
                                                    variety</br>of situation, individual and groups</td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><b>Initiative:</b></br>Identifying and dealing with
                                                    issues</br>proactively and persistently; seizing <br>oppurtunities
                                                    that aries</td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><b>Results Orientation:</b></br>Focusing personal effects on
                                                    achieving</br>results, consistent with the</br>organization
                                                    objective.</td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><b>Team work:</b></br>Working collaboratively with others to</br>
                                                    achieve common goals and positive results</td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                            </tr>
                                    ...
                                    <table class="table table2-3">
                                        <thead>
                                            <tr>
                                                <td colspan="5"
                                                    style="font-size:13.5px!important;padding:15px 10px!important;font-weight:500">
                                                    Performance Commpetencies (30% Weightage)</br>
                                                    <span
                                                        style="font-size:12.7px!important;!important;font-weight:400">The
                                                        rating should be 1 to 5 where 1 is unsatisfactory and 5 is
                                                        exceptional</span>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><b>Knowdledge Excellence:</b></br>Adhere to organizational policies
                                                    and procedure.</br> Evaluate and address issue
                                                    surrounding</br>equipment and/or operation</td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                            </tr>
                                            <tr>
                                                <td class="text-center">2</td>
                                                <td><b>Professional Confidence:</b></br>Ability to do the job. providing
                                                    an opinion or advice</br>when neccessary</td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                            </tr>
                                            <tr>
                                                <td class="text-center">3</td>
                                                <td><b>Planning and Organizing:</b></br>Define task and milestones tp
                                                    achieve objectives</br>while ensuring the optional use of resources
                                                </td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                            ...
                                            <tr>
                                                <td class="text-center">5</td>
                                                <td><b>Quality of work:</b></br>Complete assignment in time with
                                                    effectiveness &</br>efficiency</td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><b>Quantity of work:</b></br>Works collaboratively with others to
                                                    achieve common</br>goals and positive results</td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                                <td><input type="text"></td>
                                            </tr>
                    ...
                    <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab"
                        ...
                        <div class="row mt-3">
                            <div class="col">
                                <div style="background-color:white!important;padding:10px 20px;border:1px solid black">
                                    <div>
                                        <p>Manager Recommendation: <input type="text" placeholder="abc"></p>
                                        <p>Hr Recommendation: <input type="text" placeholder="abc"></p>
                                    </div>
                                </div>
                            </div>
                            <div class="text-center mt-3 mb-5">
