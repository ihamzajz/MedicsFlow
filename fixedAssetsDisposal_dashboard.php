...
<head>
    ...
    <title>Asset Disposal - Dashboard</title>
...
<body>
    ...
    <?php
        ...
        <div id="content">
          ...
          <span class="float-left">
           ...
           Assets Disposal: <?php
            ...
            $select_total = "SELECT * FROM fixed_assets_disposal_form";
        ...
        <?php
                    ...
                    $select = "SELECT * FROM fixed_assets_disposal_form";
...
<script>
  $(document).ready(function() {
    ...
    function loadData() {
      $.ajax({
        url: 'fetchData_disposal.php', // Adjust this URL to your backend script
        type: 'GET',
        data: {
          limit: limit,
          offset: offset,
