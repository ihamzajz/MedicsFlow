...
$update="UPDATE intercompanytransfer_form SET receiver_status = 'Approved' ,receiver_msg = 'Approved By $approver_name',receiver_date = '$date',status = 'Approved'  WHERE id = $id";
