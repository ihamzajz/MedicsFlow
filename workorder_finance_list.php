...
// Base conditions (Finance Approval) ✅ DO NOT CHANGE LOGIC
$whereParts = [];
$whereParts[] = "(
  (head_status = 'Approved' OR head_status = 'approved' OR be_role = 'approver' OR ceo_status = 'Approved') AND
  finance_status = 'Pending' AND
  amount > 10000 AND amount != 'TBD'
)";
...
if ($qRaw !== '') {
  ...
  $whereParts[] = "(
      ...
      OR DATE_FORMAT(`date`, '%d-%m-%Y') LIKE '{$like}'
      OR `date` LIKE '{$like}'
      OR type LIKE '{$like}'
...
<head>
  ...
  <title>Work Order - Finance Approval</title>
  ...
  <style>
    ...
    /* ✅ Action buttons (green/red + white text EXACTLY like engineering) */
    .btn-details {
      font-size: 11px;
    ...
    /* ✅ Table wrapper EXACTLY like engineering */
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0 box1-heading">Finance Dept. Approval</h5>
              </div>
                    ...
                    ?>
                        <tr id="row_<?php echo $rid; ?>">
                          ...
                          <td style="white-space:nowrap;">
                            <a href="workorder_finance_details.php?id=<?php echo $rid; ?>" class="btn-details">
