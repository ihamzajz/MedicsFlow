...
/* =========================================================
   ✅ SAME LOGIC (UNCHANGED) - Department Head List
========================================================= */
$perPage = 50;
...
// ✅ Base WHERE (same as your old query)
if ($be_depart === 'super') {
  $whereParts[] = "1=1";
} else {
  $deptSafe = mysqli_real_escape_string($conn, (string)$be_depart);
  $whereParts[] = "be_depart = '{$deptSafe}'";
}
...
<head>
  ...
  <title>Work Order - Department Head List</title>
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0 box1-heading">Department Head List</h5>
              </div>
                ...
                <table class="table table-hover align-middle mb-0" id="myTable">
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr id="row_<?php echo $rid; ?>">
                          ...
                          <td style="white-space:nowrap;">
                            <a href="workorder_dhead_details.php?id=<?php echo $rid; ?>" class="btn-details">
                    ...
                    <?php
                      ...
                      echo "<tr><td colspan='6' class='text-muted fw-semibold p-3'>No record found!</td></tr>";
                    }
                    ?>
                  </tbody>
                </table>
