...
<head>
    ...
    <title>Asset Transfer - Userdata</title>
        ...
        <div id="content">
            ...
            <a class="btn btn-dark btn-sm" href="assets_management_home.php" style="font-size:11px!important"><i class="fa-solid fa-arrow-left"></i> Home</a>
             ...
             <?php
                ...
                $select = "SELECT * FROM intercompanytransfer_form WHERE user_name = '$username' ORDER BY user_date DESC";
                  ...
                  if($data){
                    while ($row=mysqli_fetch_array($select_q)) {
                      ...
                      <tbody class="searchable">
                        <tr id="row_<?php echo $row['id']; ?>">
                        <td>
                                    <a href="interCompanyTransfer_details.php?id=<?php echo $row['id']; ?>" ><button class="btn btn-sm btn-warning" style="font-size:10px!important;font-weight:600!important;letter-spacing:0.5px!important">
                                    View Details
