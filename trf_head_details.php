                    ...
                    <div style="background-color: white!important;border:1px solid black!important; padding:20px!important"
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                ...
                                <a class="btn btn-dark btn-sm mt-1" href="trf_head_list.php" style="font-size:11px!important">
                        ...
                        <div class="row pb-1 mt-2">
                            <div class="col-md-1">
                                <a href="trf_head_approve.php?id=<?php echo $row['id']; ?>&email=<?php echo $row['email']; ?>&name=<?php echo $row['name']; ?>"
                                    class="btn-approve me-2"><i class="fa-solid fa-check"></i> Approve</a>
                            </div>
                            <div class="col-md-1"></div>

                            <div class="col-md-1">
                                <a href="trf_head_reject.php?id=<?php echo $row['id']; ?>&email=<?php echo $row['email']; ?>&name=<?php echo $row['name']; ?>"
                                    class="btn-reject"><i class="fa-solid fa-xmark"></i> Reject</a>
                            </div>
                        </div>
