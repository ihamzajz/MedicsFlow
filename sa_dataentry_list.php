...
// =========================================================
// ✅ sa_dataentry_list (SAME UI as eng_workorder_rp)
// ✅ Server-side Pagination + Search + Product + Date Range
// ✅ Filters work across ALL pages via GET params
// ✅ Base condition: super = all, else incharge = fullname AND complete_status = Pending
// =========================================================
$perPage = 50;
...
if ($be_depart === 'super') {
  ...
  $nameSafe = mysqli_real_escape_string($conn, (string)$fullname);
  $whereParts[] = "incharge = '{$nameSafe}'";
  $whereParts[] = "complete_status = 'Pending'";
}
...
<head>
  ...
  <title>Staff Allocation - Data Entry List</title>
        ...
        <div class="container-xxl">
          ...
          <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div>
                <h5 class="mb-0 box1-heading">Staff Allocation - Data Entry List</h5>
              </div>
                  ...
                  <tbody>
                    ...
                    if ($data) {
                      while ($row = mysqli_fetch_assoc($select_q)) {
                        ...
                        if (!empty($row['date'])) {
                          try {
                            // if stored as Y-m-d or datetime, show d-m-Y
                    ...
                    ?>
                        <tr id="row_<?php echo (int)$row['id']; ?>">
                          <td>
                            <a href="sa_dataentry.php?id=<?php echo (int)$row['id']; ?>" class="btn-details">
