    ...
    <body>
        ...
        <div id="content">
            ...
            <h5 class="heading-main ">
                ...
                <a class="btn btn-warning btn-sm" href="assets_management_home.php" style="font-size:11px!important"><i class="fa-solid fa-arrow-left"></i> Home</a>
                </span>Assets Receipt:
                 <span style="font-weight:normal!important;font-size:23px!important"> 
                    <?php
                ...
                <a class="btn btn-sm btn-dark ml-1" href="assets_main_dashboard.php">Assets Data</a>
                    ...
                    <table class="table table-striped" id="myTable2">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Submitter Department</th>
        ...
        <script>
            $(document).ready(function() {
              ...
              function loadData() {
                $.ajax({
                  url: 'fetchData_assets.php', // Adjust this URL to your backend script
                  type: 'GET',
                  data: {
                    limit: limit,
                    offset: offset,
